...
cmd_cisco_ip_accounting_current(scli_interp_t *interp, int argc, char **argv)
{
    ...
    if (old_cisco_ip_mib_get_lipAccountingTable(interp->peer,
						&lipAccountTable)) {
	return SCLI_ERROR;
    }
...
cmd_cisco_ip_accounting_snapshot(scli_interp_t *interp, int argc, char **argv)
{
    ...
    if (old_cisco_ip_mib_get_lipCkAccountingTable(interp->peer,
						  &lipCkAccountTable)) {
	return SCLI_ERROR;
    }
...
cmd_cisco_ip_accounting_info(scli_interp_t *interp, int argc, char **argv)
{
    ...
    if (old_cisco_ip_mib_get_lip(interp->peer, &lip)) {
	return SCLI_ERROR;
    }
