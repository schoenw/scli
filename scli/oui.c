/*
/* The following list has been created on Tue Jun 28 11:37:23 CEST 2005
...
static scli_vendor_t ieee802_vendor_table[] = {
    ...
    { 0x000EF2, "World Axle Corporation" },
    { 0x000EF3, "Smarthome" },
    ...
    { 0x000F7D, "Xirrus" },
    { 0x000F7E, "UIS Abler Electronics Co.,Ltd." },
    ...
    { 0x000FBA, "Tevebox AB" },
    { 0x000FBB, "Siemens AG, ICN M&L TDC EP" },
    ...
    { 0x0011E3, "Broadband Access Products" },
    ...
    { 0x001392, "Video54 Technologies, Inc" },
    ...
    { 0x0014CB, "GMP|Wireless Medicine,Inc." },
    { 0x0014CC, "Zetec, Inc." },
