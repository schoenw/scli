...
static GNetSnmpAttribute snmpTargetObjects_attr[] = {
...
static GNetSnmpAttribute snmpTargetAddrEntry_attr[] = {
...
static GNetSnmpAttribute snmpTargetParamsEntry_attr[] = {
...
assign_snmpTargetObjects(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gnet_snmp_attr_assign(vbl, snmpTargetObjects_oid, G_N_ELEMENTS(snmpTargetObjects_oid),
...
snmp_target_mib_get_snmpTargetObjects(GNetSnmp *s, snmp_target_mib_snmpTargetObjects_t **snmpTargetObjects, gint64 mask, GError **error)
{
    ...
    static const guint32 _base[] = {1, 3, 6, 1, 6, 3, 12, 1, 0};
    guint32 base[128];

    *snmpTargetObjects = NULL;
    memcpy(base, _base, sizeof(_base));

    gnet_snmp_attr_get(s, &in, base, 9, 8, snmpTargetObjects_attr, mask);
...
snmp_target_mib_set_snmpTargetObjects(GNetSnmp *s, snmp_target_mib_snmpTargetObjects_t *snmpTargetObjects, gint64 mask, GError **error)
{
    ...
    gnet_snmp_attr_set(s, &in, base, 10, 8, snmpTargetObjects_attr, mask, snmpTargetObjects);
...
assign_snmpTargetAddrEntry(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gnet_snmp_attr_assign(vbl, snmpTargetAddrEntry_oid, G_N_ELEMENTS(snmpTargetAddrEntry_oid),
...
snmp_target_mib_get_snmpTargetAddrTable(GNetSnmp *s, snmp_target_mib_snmpTargetAddrEntry_t ***snmpTargetAddrEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 6, 3, 12, 1, 2, 1, 0};
    guint32 base[128];

    *snmpTargetAddrEntry = NULL;
    memcpy(base, _base, sizeof(_base));

    gnet_snmp_attr_get(s, &in, base, 11, 10, snmpTargetAddrEntry_attr, mask);
...
snmp_target_mib_get_snmpTargetAddrEntry(GNetSnmp *s, snmp_target_mib_snmpTargetAddrEntry_t **snmpTargetAddrEntry, guchar *snmpTargetAddrName, guint16 _snmpTargetAddrNameLength, gint64 mask, GError **error)
{
    ...
    *snmpTargetAddrEntry = NULL;
    ...
    gnet_snmp_attr_get(s, &in, base, len, 10, snmpTargetAddrEntry_attr, mask);
...
snmp_target_mib_set_snmpTargetAddrEntry(GNetSnmp *s, snmp_target_mib_snmpTargetAddrEntry_t *snmpTargetAddrEntry, gint64 mask, GError **error)
{
    ...
    gnet_snmp_attr_set(s, &in, base, len, 10, snmpTargetAddrEntry_attr, mask, snmpTargetAddrEntry);
...
assign_snmpTargetParamsEntry(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gnet_snmp_attr_assign(vbl, snmpTargetParamsEntry_oid, G_N_ELEMENTS(snmpTargetParamsEntry_oid),
...
snmp_target_mib_get_snmpTargetParamsTable(GNetSnmp *s, snmp_target_mib_snmpTargetParamsEntry_t ***snmpTargetParamsEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 6, 3, 12, 1, 3, 1, 0};
    guint32 base[128];

    *snmpTargetParamsEntry = NULL;
    memcpy(base, _base, sizeof(_base));

    gnet_snmp_attr_get(s, &in, base, 11, 10, snmpTargetParamsEntry_attr, mask);
...
snmp_target_mib_get_snmpTargetParamsEntry(GNetSnmp *s, snmp_target_mib_snmpTargetParamsEntry_t **snmpTargetParamsEntry, guchar *snmpTargetParamsName, guint16 _snmpTargetParamsNameLength, gint64 mask, GError **error)
{
    ...
    *snmpTargetParamsEntry = NULL;
    ...
    gnet_snmp_attr_get(s, &in, base, len, 10, snmpTargetParamsEntry_attr, mask);
...
snmp_target_mib_set_snmpTargetParamsEntry(GNetSnmp *s, snmp_target_mib_snmpTargetParamsEntry_t *snmpTargetParamsEntry, gint64 mask, GError **error)
{
    ...
    gnet_snmp_attr_set(s, &in, base, len, 10, snmpTargetParamsEntry_attr, mask, snmpTargetParamsEntry);
