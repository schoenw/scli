...
typedef struct {
    ...
    guint16  _usmUserEngineIDLength;	/* (5..32) */
    guchar   usmUserName[32];
    guint16  _usmUserNameLength;	/* (1..32) */
    guchar   *usmUserSecurityName;
    guint16  _usmUserSecurityNameLength;	/* (0..255) */
    guint32  *usmUserCloneFrom;
    guint16  _usmUserCloneFromLength;	/* (0..128) */
    guint32  *usmUserAuthProtocol;
    guint16  _usmUserAuthProtocolLength;	/* (0..128) */
    guchar   *usmUserAuthKeyChange;
    guint16  _usmUserAuthKeyChangeLength;	/* (0..65535) */
    guchar   *usmUserOwnAuthKeyChange;
    guint16  _usmUserOwnAuthKeyChangeLength;	/* (0..65535) */
    guint32  *usmUserPrivProtocol;
    guint16  _usmUserPrivProtocolLength;	/* (0..128) */
    guchar   *usmUserPrivKeyChange;
    guint16  _usmUserPrivKeyChangeLength;	/* (0..65535) */
    guchar   *usmUserOwnPrivKeyChange;
    guint16  _usmUserOwnPrivKeyChangeLength;	/* (0..65535) */
    guchar   *usmUserPublic;
    guint16  _usmUserPublicLength;	/* (0..32) */
