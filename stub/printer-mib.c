...
static attribute_t attr_prtGeneralEntry[] = {
    ...
    { 4, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTGENERALCURRENTOPERATOR, "prtGeneralCurrentOperator" },
    { 5, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTGENERALSERVICEPERSON, "prtGeneralServicePerson" },
    ...
    { 16, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTGENERALPRINTERNAME, "prtGeneralPrinterName" },
    { 17, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTGENERALSERIALNUMBER, "prtGeneralSerialNumber" },
...
static attribute_t attr_prtCoverEntry[] = {
    { 2, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTCOVERDESCRIPTION, "prtCoverDescription" },
...
static attribute_t attr_prtLocalizationEntry[] = {
    { 2, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTLOCALIZATIONLANGUAGE, "prtLocalizationLanguage" },
    { 3, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTLOCALIZATIONCOUNTRY, "prtLocalizationCountry" },
...
static attribute_t attr_prtInputEntry[] = {
    ...
    { 12, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINPUTMEDIANAME, "prtInputMediaName" },
    { 13, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINPUTNAME, "prtInputName" },
    { 14, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINPUTVENDORNAME, "prtInputVendorName" },
    { 15, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINPUTMODEL, "prtInputModel" },
    { 16, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINPUTVERSION, "prtInputVersion" },
    { 17, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINPUTSERIALNUMBER, "prtInputSerialNumber" },
    { 18, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINPUTDESCRIPTION, "prtInputDescription" },
    ...
    { 21, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINPUTMEDIATYPE, "prtInputMediaType" },
    { 22, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINPUTMEDIACOLOR, "prtInputMediaColor" },
...
static attribute_t attr_prtOutputEntry[] = {
    ...
    { 7, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTOUTPUTNAME, "prtOutputName" },
    { 8, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTOUTPUTVENDORNAME, "prtOutputVendorName" },
    { 9, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTOUTPUTMODEL, "prtOutputModel" },
    { 10, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTOUTPUTVERSION, "prtOutputVersion" },
    { 11, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTOUTPUTSERIALNUMBER, "prtOutputSerialNumber" },
    { 12, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTOUTPUTDESCRIPTION, "prtOutputDescription" },
...
static attribute_t attr_prtMarkerSuppliesEntry[] = {
    ...
    { 6, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTMARKERSUPPLIESDESCRIPTION, "prtMarkerSuppliesDescription" },
...
static attribute_t attr_prtMarkerColorantEntry[] = {
    ...
    { 4, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTMARKERCOLORANTVALUE, "prtMarkerColorantValue" },
...
static attribute_t attr_prtMediaPathEntry[] = {
    ...
    { 10, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTMEDIAPATHDESCRIPTION, "prtMediaPathDescription" },
...
static attribute_t attr_prtChannelEntry[] = {
    ...
    { 3, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTCHANNELPROTOCOLVERSION, "prtChannelProtocolVersion" },
    ...
    { 9, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTCHANNELINFORMATION, "prtChannelInformation" },
    { 0, 0, 0, NULL }
};
...
static attribute_t attr_prtInterpreterEntry[] = {
    ...
    { 3, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINTERPRETERLANGLEVEL, "prtInterpreterLangLevel" },
    { 4, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINTERPRETERLANGVERSION, "prtInterpreterLangVersion" },
    { 5, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINTERPRETERDESCRIPTION, "prtInterpreterDescription" },
    { 6, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTINTERPRETERVERSION, "prtInterpreterVersion" },
...
static attribute_t attr_prtConsoleDisplayBufferEntry[] = {
    { 2, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTCONSOLEDISPLAYBUFFERTEXT, "prtConsoleDisplayBufferText" },
    { 0, 0, 0, NULL }
};
...
static attribute_t attr_prtConsoleLightEntry[] = {
    ...
    { 5, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTCONSOLEDESCRIPTION, "prtConsoleDescription" },
    { 0, 0, 0, NULL }
};
...
static attribute_t attr_prtAlertEntry[] = {
    ...
    { 8, G_SNMP_OCTET_STRING, PRINTER_MIB_PRTALERTDESCRIPTION, "prtAlertDescription" },
