...
#define IP_MIB_ICMPINMSGS           (1 << 0) 
#define IP_MIB_ICMPINERRORS         (1 << 1) 
#define IP_MIB_ICMPINDESTUNREACHS   (1 << 2) 
#define IP_MIB_ICMPINTIMEEXCDS      (1 << 3) 
#define IP_MIB_ICMPINPARMPROBS      (1 << 4) 
#define IP_MIB_ICMPINSRCQUENCHS     (1 << 5) 
#define IP_MIB_ICMPINREDIRECTS      (1 << 6) 
#define IP_MIB_ICMPINECHOS          (1 << 7) 
#define IP_MIB_ICMPINECHOREPS       (1 << 8) 
#define IP_MIB_ICMPINTIMESTAMPS     (1 << 9) 
#define IP_MIB_ICMPINTIMESTAMPREPS  (1 << 10) 
#define IP_MIB_ICMPINADDRMASKS      (1 << 11) 
#define IP_MIB_ICMPINADDRMASKREPS   (1 << 12) 
#define IP_MIB_ICMPOUTMSGS          (1 << 13) 
#define IP_MIB_ICMPOUTERRORS        (1 << 14) 
#define IP_MIB_ICMPOUTDESTUNREACHS  (1 << 15) 
#define IP_MIB_ICMPOUTTIMEEXCDS     (1 << 16) 
#define IP_MIB_ICMPOUTPARMPROBS     (1 << 17) 
#define IP_MIB_ICMPOUTSRCQUENCHS    (1 << 18) 
#define IP_MIB_ICMPOUTREDIRECTS     (1 << 19) 
#define IP_MIB_ICMPOUTECHOS         (1 << 20) 
#define IP_MIB_ICMPOUTECHOREPS      (1 << 21) 
#define IP_MIB_ICMPOUTTIMESTAMPS    (1 << 22) 
#define IP_MIB_ICMPOUTTIMESTAMPREPS (1 << 23) 
#define IP_MIB_ICMPOUTADDRMASKS     (1 << 24) 
#define IP_MIB_ICMPOUTADDRMASKREPS  (1 << 25) 
