...
GNetSnmpEnum const notification_log_mib_enums_nlmConfigLogAdminStatus[] = {
...
GNetSnmpEnum const notification_log_mib_enums_nlmConfigLogOperStatus[] = {
...
GNetSnmpEnum const notification_log_mib_enums_nlmLogVariableValueType[] = {
...
static GNetSnmpAttribute nlmConfig_attr[] = {
...
static GNetSnmpAttribute nlmConfigLogEntry_attr[] = {
...
static GNetSnmpAttribute nlmStats_attr[] = {
...
static GNetSnmpAttribute nlmStatsLogEntry_attr[] = {
    { 1, GNET_SNMP_VARBIND_TYPE_COUNTER32,
...
static GNetSnmpAttribute nlmLogEntry_attr[] = {
...
static GNetSnmpAttribute nlmLogVariableEntry_attr[] = {
...
assign_nlmConfig(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gnet_snmp_attr_assign(vbl, nlmConfig_oid, G_N_ELEMENTS(nlmConfig_oid),
...
void
notification_log_mib_get_nlmConfig(GNetSnmp *s, notification_log_mib_nlmConfig_t **nlmConfig, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    static const guint32 _base[] = {1, 3, 6, 1, 2, 1, 92, 1, 1, 0};
    guint32 base[128];

    *nlmConfig = NULL;
    memcpy(base, _base, sizeof(_base));

    gnet_snmp_attr_get(s, &in, base, 10, 9, nlmConfig_attr, mask);
...
void
notification_log_mib_set_nlmConfig(GNetSnmp *s, notification_log_mib_nlmConfig_t *nlmConfig, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    static guint32 base[] = {1, 3, 6, 1, 2, 1, 92, 1, 1, 0, 0};

    gnet_snmp_attr_set(s, &in, base, 11, 9, nlmConfig_attr, mask, nlmConfig);
...
assign_nlmConfigLogEntry(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gnet_snmp_attr_assign(vbl, nlmConfigLogEntry_oid, G_N_ELEMENTS(nlmConfigLogEntry_oid),
...
void
notification_log_mib_get_nlmConfigLogTable(GNetSnmp *s, notification_log_mib_nlmConfigLogEntry_t ***nlmConfigLogEntry, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 2, 1, 92, 1, 1, 3, 1, 0};
    guint32 base[128];

    *nlmConfigLogEntry = NULL;
    memcpy(base, _base, sizeof(_base));

    gnet_snmp_attr_get(s, &in, base, 12, 11, nlmConfigLogEntry_attr, mask);
...
void
notification_log_mib_get_nlmConfigLogEntry(GNetSnmp *s, notification_log_mib_nlmConfigLogEntry_t **nlmConfigLogEntry, guchar *nlmLogName, guint16 _nlmLogNameLength, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
    ...
    *nlmConfigLogEntry = NULL;
    ...
    gnet_snmp_attr_get(s, &in, base, len, 11, nlmConfigLogEntry_attr, mask);
...
void
notification_log_mib_set_nlmConfigLogEntry(GNetSnmp *s, notification_log_mib_nlmConfigLogEntry_t *nlmConfigLogEntry, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
    ...
    gnet_snmp_attr_set(s, &in, base, len, 11, nlmConfigLogEntry_attr, mask, nlmConfigLogEntry);
...
assign_nlmStats(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gnet_snmp_attr_assign(vbl, nlmStats_oid, G_N_ELEMENTS(nlmStats_oid),
...
void
notification_log_mib_get_nlmStats(GNetSnmp *s, notification_log_mib_nlmStats_t **nlmStats, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    static const guint32 _base[] = {1, 3, 6, 1, 2, 1, 92, 1, 2, 0};
    guint32 base[128];

    *nlmStats = NULL;
    memcpy(base, _base, sizeof(_base));

    gnet_snmp_attr_get(s, &in, base, 10, 9, nlmStats_attr, mask);
...
assign_nlmStatsLogEntry(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gnet_snmp_attr_assign(vbl, nlmStatsLogEntry_oid, G_N_ELEMENTS(nlmStatsLogEntry_oid),
...
void
notification_log_mib_get_nlmStatsLogTable(GNetSnmp *s, notification_log_mib_nlmStatsLogEntry_t ***nlmStatsLogEntry, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 2, 1, 92, 1, 2, 3, 1, 0};
    guint32 base[128];

    *nlmStatsLogEntry = NULL;
    memcpy(base, _base, sizeof(_base));

    gnet_snmp_attr_get(s, &in, base, 12, 11, nlmStatsLogEntry_attr, mask);
...
void
notification_log_mib_get_nlmStatsLogEntry(GNetSnmp *s, notification_log_mib_nlmStatsLogEntry_t **nlmStatsLogEntry, guchar *nlmLogName, guint16 _nlmLogNameLength, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
    ...
    *nlmStatsLogEntry = NULL;
    ...
    gnet_snmp_attr_get(s, &in, base, len, 11, nlmStatsLogEntry_attr, mask);
...
assign_nlmLogEntry(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gnet_snmp_attr_assign(vbl, nlmLogEntry_oid, G_N_ELEMENTS(nlmLogEntry_oid),
...
void
notification_log_mib_get_nlmLogTable(GNetSnmp *s, notification_log_mib_nlmLogEntry_t ***nlmLogEntry, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 2, 1, 92, 1, 3, 1, 1, 0};
    guint32 base[128];

    *nlmLogEntry = NULL;
    memcpy(base, _base, sizeof(_base));

    gnet_snmp_attr_get(s, &in, base, 12, 11, nlmLogEntry_attr, mask);
...
void
notification_log_mib_get_nlmLogEntry(GNetSnmp *s, notification_log_mib_nlmLogEntry_t **nlmLogEntry, guchar *nlmLogName, guint16 _nlmLogNameLength, guint32 nlmLogIndex, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
    ...
    *nlmLogEntry = NULL;
    ...
    gnet_snmp_attr_get(s, &in, base, len, 11, nlmLogEntry_attr, mask);
...
assign_nlmLogVariableEntry(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gnet_snmp_attr_assign(vbl, nlmLogVariableEntry_oid, G_N_ELEMENTS(nlmLogVariableEntry_oid),
...
void
notification_log_mib_get_nlmLogVariableTable(GNetSnmp *s, notification_log_mib_nlmLogVariableEntry_t ***nlmLogVariableEntry, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 2, 1, 92, 1, 3, 2, 1, 0};
    guint32 base[128];

    *nlmLogVariableEntry = NULL;
    memcpy(base, _base, sizeof(_base));

    gnet_snmp_attr_get(s, &in, base, 12, 11, nlmLogVariableEntry_attr, mask);
...
void
notification_log_mib_get_nlmLogVariableEntry(GNetSnmp *s, notification_log_mib_nlmLogVariableEntry_t **nlmLogVariableEntry, guchar *nlmLogName, guint16 _nlmLogNameLength, guint32 nlmLogIndex, guint32 nlmLogVariableIndex, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
    ...
    *nlmLogVariableEntry = NULL;
    ...
    gnet_snmp_attr_get(s, &in, base, len, 11, nlmLogVariableEntry_attr, mask);
