...
extern GSnmpEnum const printer_mib_enums_PrtMediaUnitTC[];

#define PRINTER_MIB_MEDIAUNIT_TENTHOUSANDTHSOFINCHES 3
#define PRINTER_MIB_MEDIAUNIT_MICROMETERS            4

extern GSnmpEnum const printer_mib_enums_MediaUnit[];
...
extern GSnmpEnum const printer_mib_enums_PrtCapacityUnitTC[];
...
extern GSnmpEnum const printer_mib_enums_CapacityUnit[];
...
extern GSnmpEnum const printer_mib_enums_PrtPrintOrientationTC[];
...
extern GSnmpEnum const printer_mib_enums_PresentOnOff[];

#define PRINTER_MIB_CODEDCHARSET_OTHER 1

extern GSnmpEnum const printer_mib_enums_CodedCharSet[];
...
extern GSnmpEnum const printer_mib_enums_PrtChannelStateTC[];
...
extern GSnmpEnum const printer_mib_enums_PrtOutputStackingOrderTC[];
...
extern GSnmpEnum const printer_mib_enums_PrtOutputPageDeliveryOrientationTC[];
...
extern GSnmpEnum const printer_mib_enums_PrtMarkerCounterUnitTC[];
...
extern GSnmpEnum const printer_mib_enums_PrtMarkerSuppliesSupplyUnitTC[];
...
extern GSnmpEnum const printer_mib_enums_PrtMarkerSuppliesClassTC[];
...
extern GSnmpEnum const printer_mib_enums_PrtMarkerColorantRoleTC[];
...
extern GSnmpEnum const printer_mib_enums_PrtMarkerAddressabilityUnitTC[];
...
extern GSnmpEnum const printer_mib_enums_PrtMediaPathMaxSpeedPrintUnitTC[];

#define PRINTER_MIB_PRTINTERPRETERTWOWAYTC_YES 3
#define PRINTER_MIB_PRTINTERPRETERTWOWAYTC_NO  4

extern GSnmpEnum const printer_mib_enums_PrtInterpreterTwoWayTC[];
...
extern GSnmpEnum const printer_mib_enums_PrtAlertSeverityLevelTC[];
