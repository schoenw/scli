 ...
 *
 * Options:
 *   --scli-include='a3ComVlanIfEntry|a3ComVirtualGroup'
 *
...
extern GSnmpEnum const productmib_enums_EntryStatus[];
...
extern GSnmpEnum const productmib_enums_RowStatus[];
...
extern GSnmpEnum const productmib_enums_A3ComVlanType[];
...
extern GSnmpEnum const productmib_enums_A3ComVlanEncapsType[];

#define PRODUCTMIB_TRUTHVALUE_TRUE  1
#define PRODUCTMIB_TRUTHVALUE_FALSE 2

extern GSnmpEnum const productmib_enums_TruthValue[];
...
extern void
productmib_get_a3ComVlanIfTable(GSnmpSession *s, productmib_a3ComVlanIfEntry_t ***a3ComVlanIfEntry, gint64 mask);
...
extern void
productmib_get_a3ComVlanIfEntry(GSnmpSession *s, productmib_a3ComVlanIfEntry_t **a3ComVlanIfEntry, gint32 a3ComVlanIfIndex, gint64 mask);

extern void
productmib_set_a3ComVlanIfEntry(GSnmpSession *s, productmib_a3ComVlanIfEntry_t *a3ComVlanIfEntry, gint64 mask);
...
extern void
productmib_get_a3ComVirtualGroup(GSnmpSession *s, productmib_a3ComVirtualGroup_t **a3ComVirtualGroup, gint64 mask);
