...
#define NOTIFICATION_LOG_MIB_NLMCONFIGLOGSTORAGETYPE_OTHER       1
#define NOTIFICATION_LOG_MIB_NLMCONFIGLOGSTORAGETYPE_VOLATILE    2
#define NOTIFICATION_LOG_MIB_NLMCONFIGLOGSTORAGETYPE_NONVOLATILE 3
#define NOTIFICATION_LOG_MIB_NLMCONFIGLOGSTORAGETYPE_PERMANENT   4
#define NOTIFICATION_LOG_MIB_NLMCONFIGLOGSTORAGETYPE_READONLY    5

extern GSnmpEnum const notification_log_mib_enums_nlmConfigLogStorageType[];

#define NOTIFICATION_LOG_MIB_NLMCONFIGLOGENTRYSTATUS_ACTIVE        1
#define NOTIFICATION_LOG_MIB_NLMCONFIGLOGENTRYSTATUS_NOTINSERVICE  2
#define NOTIFICATION_LOG_MIB_NLMCONFIGLOGENTRYSTATUS_NOTREADY      3
#define NOTIFICATION_LOG_MIB_NLMCONFIGLOGENTRYSTATUS_CREATEANDGO   4
#define NOTIFICATION_LOG_MIB_NLMCONFIGLOGENTRYSTATUS_CREATEANDWAIT 5
#define NOTIFICATION_LOG_MIB_NLMCONFIGLOGENTRYSTATUS_DESTROY       6

extern GSnmpEnum const notification_log_mib_enums_nlmConfigLogEntryStatus[];
...
typedef struct {
    guint32  *nlmConfigGlobalEntryLimit;
    guint32  *nlmConfigGlobalAgeOut;
...
#define NOTIFICATION_LOG_MIB_NLMCONFIGLOGFILTERNAMEMAXLENGTH 32
    ...
    guint32  *nlmConfigLogEntryLimit;
    gint32   *nlmConfigLogAdminStatus;
    gint32   *nlmConfigLogOperStatus;
    gint32   *nlmConfigLogStorageType;
    gint32   *nlmConfigLogEntryStatus;
...
typedef struct {
    guint32  *nlmStatsGlobalNotificationsLogged;
    guint32  *nlmStatsGlobalNotificationsBumped;
...
#define NOTIFICATION_LOG_MIB_NLMLOGNAMEMAXLENGTH 32
    guint16  _nlmLogNameLength;
    guint32  *nlmStatsLogNotificationsLogged;
    guint32  *nlmStatsLogNotificationsBumped;
...
#define NOTIFICATION_LOG_MIB_NLMLOGNAMEMAXLENGTH 32
    guint16  _nlmLogNameLength;
    guint32  nlmLogIndex;
    guint32  nlmLogVariableIndex;
    guint32  *nlmLogVariableID;
...
#define NOTIFICATION_LOG_MIB_NLMLOGVARIABLEIDMAXLENGTH 128
    ...
    gint32   *nlmLogVariableValueType;
    guint32  *nlmLogVariableCounter32Val;
    guint32  *nlmLogVariableUnsigned32Val;
    guint32  *nlmLogVariableTimeTicksVal;
    gint32   *nlmLogVariableInteger32Val;
    guchar   *nlmLogVariableOctetStringVal;
...
#define NOTIFICATION_LOG_MIB_NLMLOGVARIABLEOIDVALMAXLENGTH 128
    ...
    guint64  *nlmLogVariableCounter64Val; 
    guchar   *nlmLogVariableOpaqueVal;
