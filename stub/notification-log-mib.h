...
typedef struct {
    ...
    guint32  *nlmConfigGlobalAgeOut;         /* rw Unsigned32 [minutes] */
...
typedef struct {
    guint32  *nlmStatsGlobalNotificationsLogged;     /* ro SNMPv2-SMI::Counter32 [notifications] */
    guint32  *nlmStatsGlobalNotificationsBumped;     /* ro SNMPv2-SMI::Counter32 [notifications] */
...
#define NOTIFICATION_LOG_MIB_NLMLOGNAMEMAXLENGTH 32
    guint16  _nlmLogNameLength;
    guint32  *nlmStatsLogNotificationsLogged;     /* ro SNMPv2-SMI::Counter32 [notifications] */
    guint32  *nlmStatsLogNotificationsBumped;     /* ro SNMPv2-SMI::Counter32 [notifications] */
