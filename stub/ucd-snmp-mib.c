...
static GSnmpAttribute logMatch_attr[] = {
    { 1, GNET_SNMP_VARBIND_TYPE_INTEGER32,
...
static GSnmpAttribute logMatchEntry_attr[] = {
    { 2, GNET_SNMP_VARBIND_TYPE_OCTETSTRING,
...
void
ucd_snmp_mib_get_prTable(GSnmpSession *s, ucd_snmp_mib_prEntry_t ***prEntry, gint64 mask)
{
...
void
ucd_snmp_mib_get_prEntry(GSnmpSession *s, ucd_snmp_mib_prEntry_t **prEntry, gint32 prIndex, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
...
void
ucd_snmp_mib_set_prEntry(GSnmpSession *s, ucd_snmp_mib_prEntry_t *prEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
...
void
ucd_snmp_mib_get_memory(GSnmpSession *s, ucd_snmp_mib_memory_t **memory, gint64 mask)
{
    GList *in = NULL, *out = NULL;
...
void
ucd_snmp_mib_get_extTable(GSnmpSession *s, ucd_snmp_mib_extEntry_t ***extEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
...
void
ucd_snmp_mib_get_extEntry(GSnmpSession *s, ucd_snmp_mib_extEntry_t **extEntry, gint32 extIndex, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
...
void
ucd_snmp_mib_set_extEntry(GSnmpSession *s, ucd_snmp_mib_extEntry_t *extEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
...
void
ucd_snmp_mib_get_dskTable(GSnmpSession *s, ucd_snmp_mib_dskEntry_t ***dskEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
...
void
ucd_snmp_mib_get_dskEntry(GSnmpSession *s, ucd_snmp_mib_dskEntry_t **dskEntry, gint32 dskIndex, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
...
void
ucd_snmp_mib_get_laTable(GSnmpSession *s, ucd_snmp_mib_laEntry_t ***laEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
...
void
ucd_snmp_mib_get_laEntry(GSnmpSession *s, ucd_snmp_mib_laEntry_t **laEntry, gint32 laIndex, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
...
void
ucd_snmp_mib_get_systemStats(GSnmpSession *s, ucd_snmp_mib_systemStats_t **systemStats, gint64 mask)
{
    GList *in = NULL, *out = NULL;
...
void
ucd_snmp_mib_get_fileTable(GSnmpSession *s, ucd_snmp_mib_fileEntry_t ***fileEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
...
void
ucd_snmp_mib_get_fileEntry(GSnmpSession *s, ucd_snmp_mib_fileEntry_t **fileEntry, gint32 fileIndex, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
...
assign_logMatch(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gsnmp_attr_assign(vbl, logMatch_oid, sizeof(logMatch_oid)/sizeof(guint32),
...
void
ucd_snmp_mib_get_logMatch(GSnmpSession *s, ucd_snmp_mib_logMatch_t **logMatch, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    ...
    *logMatch = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 9, 8, logMatch_attr, mask);
...
assign_logMatchEntry(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gsnmp_attr_assign(vbl, logMatchEntry_oid, sizeof(logMatchEntry_oid)/sizeof(guint32),
...
void
ucd_snmp_mib_get_logMatchTable(GSnmpSession *s, ucd_snmp_mib_logMatchEntry_t ***logMatchEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
    ...
    *logMatchEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 11, 10, logMatchEntry_attr, mask);
...
void
ucd_snmp_mib_get_logMatchEntry(GSnmpSession *s, ucd_snmp_mib_logMatchEntry_t **logMatchEntry, gint32 logMatchIndex, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
    ...
    *logMatchEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, len, 10, logMatchEntry_attr, mask);
...
void
ucd_snmp_mib_get_version(GSnmpSession *s, ucd_snmp_mib_version_t **version, gint64 mask)
{
    GList *in = NULL, *out = NULL;
...
void
ucd_snmp_mib_set_version(GSnmpSession *s, ucd_snmp_mib_version_t *version, gint64 mask)
{
    GList *in = NULL, *out = NULL;
...
void
ucd_snmp_mib_set_versionSavePersistentData(GSnmpSession *s, gint32 versionSavePersistentData)
{
    ucd_snmp_mib_version_t *version;
...
void
ucd_snmp_mib_get_snmperrs(GSnmpSession *s, ucd_snmp_mib_snmperrs_t **snmperrs, gint64 mask)
{
    GList *in = NULL, *out = NULL;
...
void
ucd_snmp_mib_get_mrTable(GSnmpSession *s, ucd_snmp_mib_mrEntry_t ***mrEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
...
void
ucd_snmp_mib_get_mrEntry(GSnmpSession *s, ucd_snmp_mib_mrEntry_t **mrEntry, guint32 *mrIndex, guint16 _mrIndexLength, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
