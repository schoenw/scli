...
static guint32 const ucdStart[]
	= { UCD_SNMP_MIB_UCDSTART };
static guint32 const ucdShutdown[]
	= { UCD_SNMP_MIB_UCDSHUTDOWN };

GNetSnmpIdentity const ucd_snmp_mib_notifications[] = {
    { ucdStart,
      G_N_ELEMENTS(ucdStart),
      "ucdStart" },
    { ucdShutdown,
      G_N_ELEMENTS(ucdShutdown),
      "ucdShutdown" },
    { 0, 0, NULL }
};
...
static GNetSnmpAttribute systemStats_attr[] = {
    ...
    { 60, GNET_SNMP_VARBIND_TYPE_COUNTER32,
      ...
      0,
      0 },
    { 61, GNET_SNMP_VARBIND_TYPE_COUNTER32,
      UCD_SNMP_MIB_SSCPURAWSOFTIRQ, "ssCpuRawSoftIRQ",
       NULL,
      G_STRUCT_OFFSET(ucd_snmp_mib_systemStats_t, ssCpuRawSoftIRQ),
      0,
      0 },
    { 62, GNET_SNMP_VARBIND_TYPE_COUNTER32,
      UCD_SNMP_MIB_SSRAWSWAPIN, "ssRawSwapIn",
       NULL,
      G_STRUCT_OFFSET(ucd_snmp_mib_systemStats_t, ssRawSwapIn),
      0,
      0 },
    { 63, GNET_SNMP_VARBIND_TYPE_COUNTER32,
      UCD_SNMP_MIB_SSRAWSWAPOUT, "ssRawSwapOut",
       NULL,
      G_STRUCT_OFFSET(ucd_snmp_mib_systemStats_t, ssRawSwapOut),
      0,
      0 },
    { 0, 0, 0, NULL }
};
...
ucd_snmp_mib_get_prTable(GNetSnmp *s, ucd_snmp_mib_prEntry_t ***prEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 2021, 2, 1, 0};
    guint32 base[128];
...
ucd_snmp_mib_set_prErrFix(GNetSnmp *s, gint32 prIndex, gint32 prErrFix, GError **error)
{
    ...
    ucd_snmp_mib_get_prEntry(s, &prEntry, prIndex, UCD_SNMP_MIB_PRERRFIX, error);
    if (error && *error) return;
    if (s->error_status || !prEntry) return;
    prEntry->prErrFix = &prErrFix;
    ucd_snmp_mib_set_prEntry(s, prEntry, UCD_SNMP_MIB_PRERRFIX, error);
...
{
    GList *in = NULL, *out = NULL;
    static const guint32 _base[] = {1, 3, 6, 1, 4, 1, 2021, 4, 0};
    guint32 base[128];
...
ucd_snmp_mib_get_extTable(GNetSnmp *s, ucd_snmp_mib_extEntry_t ***extEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 2021, 8, 1, 0};
    guint32 base[128];
...
ucd_snmp_mib_set_extErrFix(GNetSnmp *s, gint32 extIndex, gint32 extErrFix, GError **error)
{
    ...
    ucd_snmp_mib_get_extEntry(s, &extEntry, extIndex, UCD_SNMP_MIB_EXTERRFIX, error);
    if (error && *error) return;
    if (s->error_status || !extEntry) return;
    extEntry->extErrFix = &extErrFix;
    ucd_snmp_mib_set_extEntry(s, extEntry, UCD_SNMP_MIB_EXTERRFIX, error);
...
ucd_snmp_mib_get_dskTable(GNetSnmp *s, ucd_snmp_mib_dskEntry_t ***dskEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 2021, 9, 1, 0};
    guint32 base[128];
...
ucd_snmp_mib_get_laTable(GNetSnmp *s, ucd_snmp_mib_laEntry_t ***laEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 2021, 10, 1, 0};
    guint32 base[128];
...
{
    GList *in = NULL, *out = NULL;
    static const guint32 _base[] = {1, 3, 6, 1, 4, 1, 2021, 11, 0};
    guint32 base[128];
...
ucd_snmp_mib_get_fileTable(GNetSnmp *s, ucd_snmp_mib_fileEntry_t ***fileEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 2021, 15, 1, 0};
    guint32 base[128];
...
{
    GList *in = NULL, *out = NULL;
    static const guint32 _base[] = {1, 3, 6, 1, 4, 1, 2021, 16, 0};
    guint32 base[128];
...
ucd_snmp_mib_get_logMatchTable(GNetSnmp *s, ucd_snmp_mib_logMatchEntry_t ***logMatchEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 2021, 16, 2, 1, 0};
    guint32 base[128];
...
{
    GList *in = NULL, *out = NULL;
    static const guint32 _base[] = {1, 3, 6, 1, 4, 1, 2021, 100, 0};
    guint32 base[128];
...
ucd_snmp_mib_set_versionClearCache(GNetSnmp *s, gint32 versionClearCache, GError **error)
{
    ...
    ucd_snmp_mib_get_version(s, &version, UCD_SNMP_MIB_VERSIONCLEARCACHE, error);
    if (error && *error) return;
    if (s->error_status || !version) return;
    version->versionClearCache = &versionClearCache;
    ucd_snmp_mib_set_version(s, version, UCD_SNMP_MIB_VERSIONCLEARCACHE, error);
...
ucd_snmp_mib_set_versionUpdateConfig(GNetSnmp *s, gint32 versionUpdateConfig, GError **error)
{
    ...
    ucd_snmp_mib_get_version(s, &version, UCD_SNMP_MIB_VERSIONUPDATECONFIG, error);
    if (error && *error) return;
    if (s->error_status || !version) return;
    version->versionUpdateConfig = &versionUpdateConfig;
    ucd_snmp_mib_set_version(s, version, UCD_SNMP_MIB_VERSIONUPDATECONFIG, error);
    ucd_snmp_mib_free_version(version);
}
...
ucd_snmp_mib_set_versionRestartAgent(GNetSnmp *s, gint32 versionRestartAgent, GError **error)
{
    ...
    ucd_snmp_mib_get_version(s, &version, UCD_SNMP_MIB_VERSIONRESTARTAGENT, error);
    if (error && *error) return;
    if (s->error_status || !version) return;
    version->versionRestartAgent = &versionRestartAgent;
    ucd_snmp_mib_set_version(s, version, UCD_SNMP_MIB_VERSIONRESTARTAGENT, error);
    ucd_snmp_mib_free_version(version);
}
...
ucd_snmp_mib_set_versionSavePersistentData(GNetSnmp *s, gint32 versionSavePersistentData, GError **error)
{
    ...
    ucd_snmp_mib_get_version(s, &version, UCD_SNMP_MIB_VERSIONSAVEPERSISTENTDATA, error);
    if (error && *error) return;
    if (s->error_status || !version) return;
    version->versionSavePersistentData = &versionSavePersistentData;
    ucd_snmp_mib_set_version(s, version, UCD_SNMP_MIB_VERSIONSAVEPERSISTENTDATA, error);
    ucd_snmp_mib_free_version(version);
}
...
ucd_snmp_mib_set_versionDoDebugging(GNetSnmp *s, gint32 versionDoDebugging, GError **error)
{
    ...
    ucd_snmp_mib_get_version(s, &version, UCD_SNMP_MIB_VERSIONDODEBUGGING, error);
    if (error && *error) return;
    if (s->error_status || !version) return;
    version->versionDoDebugging = &versionDoDebugging;
    ucd_snmp_mib_set_version(s, version, UCD_SNMP_MIB_VERSIONDODEBUGGING, error);
    ucd_snmp_mib_free_version(version);
}
...
{
    GList *in = NULL, *out = NULL;
    static const guint32 _base[] = {1, 3, 6, 1, 4, 1, 2021, 101, 0};
    guint32 base[128];
...
ucd_snmp_mib_get_mrTable(GNetSnmp *s, ucd_snmp_mib_mrEntry_t ***mrEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 2021, 102, 1, 0};
    guint32 base[128];
