...
void
snmp_mpd_mib_get_snmpMPDStats(GNetSnmp *s, snmp_mpd_mib_snmpMPDStats_t **snmpMPDStats, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    static const guint32 _base[] = {1, 3, 6, 1, 6, 3, 11, 2, 1, 0};
    guint32 base[128];
