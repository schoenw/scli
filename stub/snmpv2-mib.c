...
static attribute_t attr_system[] = {
    { 1, G_SNMP_OCTETSTRING, SNMPV2_MIB_SYSDESCR, "sysDescr" },
    { 2, G_SNMP_OBJECTID, SNMPV2_MIB_SYSOBJECTID, "sysObjectID" },
    { 3, G_SNMP_TIMETICKS, SNMPV2_MIB_SYSUPTIME, "sysUpTime" },
    { 4, G_SNMP_OCTETSTRING, SNMPV2_MIB_SYSCONTACT, "sysContact" },
    { 5, G_SNMP_OCTETSTRING, SNMPV2_MIB_SYSNAME, "sysName" },
    { 6, G_SNMP_OCTETSTRING, SNMPV2_MIB_SYSLOCATION, "sysLocation" },
...
static attribute_t attr_sysOREntry[] = {
    { 2, G_SNMP_OBJECTID, SNMPV2_MIB_SYSORID, "sysORID" },
    { 3, G_SNMP_OCTETSTRING, SNMPV2_MIB_SYSORDESCR, "sysORDescr" },
