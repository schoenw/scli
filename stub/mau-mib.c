...
void
mau_mib_set_rpMauStatus(GSnmpSession *s, gint32 rpMauGroupIndex, gint32 rpMauPortIndex, gint32 rpMauIndex, gint32 rpMauStatus)
{
    mau_mib_rpMauEntry_t *rpMauEntry;

    mau_mib_get_rpMauEntry(s, &rpMauEntry, rpMauGroupIndex, rpMauPortIndex, rpMauIndex, MAU_MIB_RPMAUSTATUS);
    if (s->error_status || !rpMauEntry) return;
    rpMauEntry->rpMauStatus = &rpMauStatus;
    mau_mib_set_rpMauEntry(s, rpMauEntry, MAU_MIB_RPMAUSTATUS);
    mau_mib_free_rpMauEntry(rpMauEntry);
}
...
void
mau_mib_set_ifMauStatus(GSnmpSession *s, gint32 ifMauIfIndex, gint32 ifMauIndex, gint32 ifMauStatus)
{
    mau_mib_ifMauEntry_t *ifMauEntry;

    mau_mib_get_ifMauEntry(s, &ifMauEntry, ifMauIfIndex, ifMauIndex, MAU_MIB_IFMAUSTATUS);
    if (s->error_status || !ifMauEntry) return;
    ifMauEntry->ifMauStatus = &ifMauStatus;
    mau_mib_set_ifMauEntry(s, ifMauEntry, MAU_MIB_IFMAUSTATUS);
    mau_mib_free_ifMauEntry(ifMauEntry);
}

void
mau_mib_set_ifMauDefaultType(GSnmpSession *s, gint32 ifMauIfIndex, gint32 ifMauIndex, guint32 *ifMauDefaultType, guint16 _ifMauDefaultTypeLength)
{
    mau_mib_ifMauEntry_t *ifMauEntry;

    mau_mib_get_ifMauEntry(s, &ifMauEntry, ifMauIfIndex, ifMauIndex, MAU_MIB_IFMAUDEFAULTTYPE);
    if (s->error_status || !ifMauEntry) return;
    ifMauEntry->ifMauDefaultType = ifMauDefaultType;
    ifMauEntry->_ifMauDefaultTypeLength = _ifMauDefaultTypeLength;
    mau_mib_set_ifMauEntry(s, ifMauEntry, MAU_MIB_IFMAUDEFAULTTYPE);
    mau_mib_free_ifMauEntry(ifMauEntry);
}
...
void
mau_mib_set_ifMauAutoNegAdminStatus(GSnmpSession *s, gint32 ifMauIfIndex, gint32 ifMauIndex, gint32 ifMauAutoNegAdminStatus)
{
    mau_mib_ifMauAutoNegEntry_t *ifMauAutoNegEntry;

    mau_mib_get_ifMauAutoNegEntry(s, &ifMauAutoNegEntry, ifMauIfIndex, ifMauIndex, MAU_MIB_IFMAUAUTONEGADMINSTATUS);
    if (s->error_status || !ifMauAutoNegEntry) return;
    ifMauAutoNegEntry->ifMauAutoNegAdminStatus = &ifMauAutoNegAdminStatus;
    mau_mib_set_ifMauAutoNegEntry(s, ifMauAutoNegEntry, MAU_MIB_IFMAUAUTONEGADMINSTATUS);
    mau_mib_free_ifMauAutoNegEntry(ifMauAutoNegEntry);
}

void
mau_mib_set_ifMauAutoNegCapAdvertised(GSnmpSession *s, gint32 ifMauIfIndex, gint32 ifMauIndex, gint32 ifMauAutoNegCapAdvertised)
{
    mau_mib_ifMauAutoNegEntry_t *ifMauAutoNegEntry;

    mau_mib_get_ifMauAutoNegEntry(s, &ifMauAutoNegEntry, ifMauIfIndex, ifMauIndex, MAU_MIB_IFMAUAUTONEGCAPADVERTISED);
    if (s->error_status || !ifMauAutoNegEntry) return;
    ifMauAutoNegEntry->ifMauAutoNegCapAdvertised = &ifMauAutoNegCapAdvertised;
    mau_mib_set_ifMauAutoNegEntry(s, ifMauAutoNegEntry, MAU_MIB_IFMAUAUTONEGCAPADVERTISED);
    mau_mib_free_ifMauAutoNegEntry(ifMauAutoNegEntry);
}

void
mau_mib_set_ifMauAutoNegRestart(GSnmpSession *s, gint32 ifMauIfIndex, gint32 ifMauIndex, gint32 ifMauAutoNegRestart)
{
    mau_mib_ifMauAutoNegEntry_t *ifMauAutoNegEntry;

    mau_mib_get_ifMauAutoNegEntry(s, &ifMauAutoNegEntry, ifMauIfIndex, ifMauIndex, MAU_MIB_IFMAUAUTONEGRESTART);
    if (s->error_status || !ifMauAutoNegEntry) return;
    ifMauAutoNegEntry->ifMauAutoNegRestart = &ifMauAutoNegRestart;
    mau_mib_set_ifMauAutoNegEntry(s, ifMauAutoNegEntry, MAU_MIB_IFMAUAUTONEGRESTART);
    mau_mib_free_ifMauAutoNegEntry(ifMauAutoNegEntry);
}

void
mau_mib_set_ifMauAutoNegCapAdvertisedBits(GSnmpSession *s, gint32 ifMauIfIndex, gint32 ifMauIndex, guchar *ifMauAutoNegCapAdvertisedBits, guint16 _ifMauAutoNegCapAdvertisedBitsLength)
{
    mau_mib_ifMauAutoNegEntry_t *ifMauAutoNegEntry;

    mau_mib_get_ifMauAutoNegEntry(s, &ifMauAutoNegEntry, ifMauIfIndex, ifMauIndex, MAU_MIB_IFMAUAUTONEGCAPADVERTISEDBITS);
    if (s->error_status || !ifMauAutoNegEntry) return;
    /* ?? */
    mau_mib_set_ifMauAutoNegEntry(s, ifMauAutoNegEntry, MAU_MIB_IFMAUAUTONEGCAPADVERTISEDBITS);
    mau_mib_free_ifMauAutoNegEntry(ifMauAutoNegEntry);
}

void
mau_mib_set_ifMauAutoNegRemoteFaultAdvertised(GSnmpSession *s, gint32 ifMauIfIndex, gint32 ifMauIndex, gint32 ifMauAutoNegRemoteFaultAdvertised)
{
    mau_mib_ifMauAutoNegEntry_t *ifMauAutoNegEntry;

    mau_mib_get_ifMauAutoNegEntry(s, &ifMauAutoNegEntry, ifMauIfIndex, ifMauIndex, MAU_MIB_IFMAUAUTONEGREMOTEFAULTADVERTISED);
    if (s->error_status || !ifMauAutoNegEntry) return;
    ifMauAutoNegEntry->ifMauAutoNegRemoteFaultAdvertised = &ifMauAutoNegRemoteFaultAdvertised;
    mau_mib_set_ifMauAutoNegEntry(s, ifMauAutoNegEntry, MAU_MIB_IFMAUAUTONEGREMOTEFAULTADVERTISED);
    mau_mib_free_ifMauAutoNegEntry(ifMauAutoNegEntry);
}
