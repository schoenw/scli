...
void
cisco_dot11_association_mib_get_cd11IfCipherStatsTable(GNetSnmp *s, cisco_dot11_association_mib_cd11IfCipherStatsEntry_t ***cd11IfCipherStatsEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
...
void
cisco_dot11_association_mib_get_cd11IfCipherStatsEntry(GNetSnmp *s, cisco_dot11_association_mib_cd11IfCipherStatsEntry_t **cd11IfCipherStatsEntry, gint32 ifIndex, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
