...
GNetSnmpEnum const cisco_dot11_association_mib_enums_CDot11ClientDevType[] = {
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTDEVTYPE_UNKNOWN,            "unknown" },
    ...
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTDEVTYPE_CB21AGCLIENT,       "cb21agClient" },
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTDEVTYPE_RADIOKODIAK,        "radioKodiak" },
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTDEVTYPE_C1130SERIESAP,      "c1130SeriesAP" },
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTDEVTYPE_C1310SERIESBRIDGE,  "c1310SeriesBridge" },
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTDEVTYPE_C7920PHONE,         "c7920phone" },
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTDEVTYPE_C1240SERIESAP,      "c1240SeriesAP" },
    { 0, NULL }
};

GNetSnmpEnum const cisco_dot11_association_mib_enums_CDot11ClientRadioType[] = {
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTRADIOTYPE_UNKNOWN,    "unknown" },
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTRADIOTYPE_CCXCLIENT,  "ccxClient" },
    ...
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTRADIOTYPE_RM2XSERIES, "rm2xSeries" },
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTRADIOTYPE_RM2GSERIES, "rm2gSeries" },
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTRADIOTYPE_MP2XMAR,    "mp2xMAR" },
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTRADIOTYPE_CB21AG,     "cb21ag" },
    { 0, NULL }
};

GNetSnmpEnum const cisco_dot11_association_mib_enums_CDot11AuthenticationMethod[] = {
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11AUTHENTICATIONMETHOD_OPEN,       "open" },
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11AUTHENTICATIONMETHOD_SHAREDKEY,  "sharedKey" },
    { CISCO_DOT11_ASSOCIATION_MIB_CDOT11AUTHENTICATIONMETHOD_NETWORKEAP, "networkEap" },
    { 0, NULL }
};
...
static guint16 cd11IfCipherMicFailClientAddress_constraints[] = {6U, 6U, 0, 0};
...
static guint32 cDot11ClientVlanId_constraints[] = {0UL, 4095UL, 0, 0};
static gint32 cDot11ClientSubIfIndex_constraints[] = {1L, 2147483647L, 0, 0};
...
static guint32 const cd11IfCipherStatsEntry_oid[] = {1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 1, 4, 1};

static GNetSnmpAttribute cd11IfCipherStatsEntry_attr[] = {
    { 1, GNET_SNMP_VARBIND_TYPE_OCTETSTRING,
      CISCO_DOT11_ASSOCIATION_MIB_CD11IFCIPHERMICFAILCLIENTADDRESS, "cd11IfCipherMicFailClientAddress",
       cd11IfCipherMicFailClientAddress_constraints,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cd11IfCipherStatsEntry_t, cd11IfCipherMicFailClientAddress),
      6,
      GSNMP_ATTR_FLAG_FIXED_LENGTH },
    { 2, GNET_SNMP_VARBIND_TYPE_COUNTER32,
      CISCO_DOT11_ASSOCIATION_MIB_CD11IFCIPHERTKIPLOCALMICFAILURES, "cd11IfCipherTkipLocalMicFailures",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cd11IfCipherStatsEntry_t, cd11IfCipherTkipLocalMicFailures),
      0,
      0 },
    { 3, GNET_SNMP_VARBIND_TYPE_COUNTER32,
      CISCO_DOT11_ASSOCIATION_MIB_CD11IFCIPHERTKIPREMOTMICFAILURES, "cd11IfCipherTkipRemotMicFailures",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cd11IfCipherStatsEntry_t, cd11IfCipherTkipRemotMicFailures),
      0,
      0 },
    { 4, GNET_SNMP_VARBIND_TYPE_COUNTER32,
      CISCO_DOT11_ASSOCIATION_MIB_CD11IFCIPHERTKIPCOUNTERMEASINVOK, "cd11IfCipherTkipCounterMeasInvok",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cd11IfCipherStatsEntry_t, cd11IfCipherTkipCounterMeasInvok),
      0,
      0 },
    { 5, GNET_SNMP_VARBIND_TYPE_COUNTER32,
      CISCO_DOT11_ASSOCIATION_MIB_CD11IFCIPHERCCMPREPLAYSDISCARDED, "cd11IfCipherCcmpReplaysDiscarded",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cd11IfCipherStatsEntry_t, cd11IfCipherCcmpReplaysDiscarded),
      0,
      0 },
    { 6, GNET_SNMP_VARBIND_TYPE_COUNTER32,
      CISCO_DOT11_ASSOCIATION_MIB_CD11IFCIPHERTKIPREPLAYSDETECTED, "cd11IfCipherTkipReplaysDetected",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cd11IfCipherStatsEntry_t, cd11IfCipherTkipReplaysDetected),
      0,
      0 },
    { 0, 0, 0, NULL }
};
...
static GNetSnmpAttribute cDot11ClientConfigInfoEntry_attr[] = {
    ...
    { 16, GNET_SNMP_VARBIND_TYPE_OCTETSTRING,
      ...
      0 },
    { 17, GNET_SNMP_VARBIND_TYPE_UNSIGNED32,
      CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTVLANID, "cDot11ClientVlanId",
       cDot11ClientVlanId_constraints,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, cDot11ClientVlanId),
      0,
      0 },
    { 18, GNET_SNMP_VARBIND_TYPE_INTEGER32,
      CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTSUBIFINDEX, "cDot11ClientSubIfIndex",
       cDot11ClientSubIfIndex_constraints,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, cDot11ClientSubIfIndex),
      0,
      0 },
    { 19, GNET_SNMP_VARBIND_TYPE_INTEGER32,
      CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTAUTHENALGORITHM, "cDot11ClientAuthenAlgorithm",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, cDot11ClientAuthenAlgorithm),
      0,
      0 },
    { 20, GNET_SNMP_VARBIND_TYPE_OCTETSTRING,
      CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTADDITIONALAUTHEN, "cDot11ClientAdditionalAuthen",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, cDot11ClientAdditionalAuthen),
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, _cDot11ClientAdditionalAuthenLength),
      0 },
    { 21, GNET_SNMP_VARBIND_TYPE_OCTETSTRING,
      CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTDOT1XAUTHENALGORITHM, "cDot11ClientDot1xAuthenAlgorithm",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, cDot11ClientDot1xAuthenAlgorithm),
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, _cDot11ClientDot1xAuthenAlgorithmLength),
      0 },
    { 22, GNET_SNMP_VARBIND_TYPE_OCTETSTRING,
      CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTKEYMANAGEMENT, "cDot11ClientKeyManagement",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, cDot11ClientKeyManagement),
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, _cDot11ClientKeyManagementLength),
      0 },
    { 23, GNET_SNMP_VARBIND_TYPE_OCTETSTRING,
      CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTUNICASTCIPHER, "cDot11ClientUnicastCipher",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, cDot11ClientUnicastCipher),
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, _cDot11ClientUnicastCipherLength),
      0 },
    { 24, GNET_SNMP_VARBIND_TYPE_OCTETSTRING,
      CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTMULTICASTCIPHER, "cDot11ClientMulticastCipher",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, cDot11ClientMulticastCipher),
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, _cDot11ClientMulticastCipherLength),
      0 },
    { 25, GNET_SNMP_VARBIND_TYPE_OBJECTID,
      CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTDEVOBJECTID, "cDot11ClientDevObjectID",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, cDot11ClientDevObjectID),
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, _cDot11ClientDevObjectIDLength),
      0 },
    { 26, GNET_SNMP_VARBIND_TYPE_OCTETSTRING,
      CISCO_DOT11_ASSOCIATION_MIB_CDOT11CLIENTNEWKEYMANAGEMENT, "cDot11ClientNewKeyManagement",
       NULL,
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, cDot11ClientNewKeyManagement),
      G_STRUCT_OFFSET(cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t, _cDot11ClientNewKeyManagementLength),
      0 },
    { 0, 0, 0, NULL }
};
...
cisco_dot11_association_mib_get_cDot11AssociationGlobal(GNetSnmp *s, cisco_dot11_association_mib_cDot11AssociationGlobal_t **cDot11AssociationGlobal, gint64 mask, GError **error)
{
    ...
    static const guint32 _base[] = {1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 1, 0};
    guint32 base[128];
...
cisco_dot11_association_mib_get_cDot11ActiveDevicesTable(GNetSnmp *s, cisco_dot11_association_mib_cDot11ActiveDevicesEntry_t ***cDot11ActiveDevicesEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 1, 2, 1, 0};
    guint32 base[128];
...
cisco_dot11_association_mib_get_cDot11AssociationStatsTable(GNetSnmp *s, cisco_dot11_association_mib_cDot11AssociationStatsEntry_t ***cDot11AssociationStatsEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 1, 3, 1, 0};
    guint32 base[128];
...
cisco_dot11_association_mib_new_cd11IfCipherStatsEntry()
{
    cisco_dot11_association_mib_cd11IfCipherStatsEntry_t *cd11IfCipherStatsEntry;

    cd11IfCipherStatsEntry = (cisco_dot11_association_mib_cd11IfCipherStatsEntry_t *) g_malloc0(sizeof(cisco_dot11_association_mib_cd11IfCipherStatsEntry_t) + sizeof(gpointer));
    return cd11IfCipherStatsEntry;
}

static inline int
unpack_cd11IfCipherStatsEntry(GNetSnmpVarBind *vb, cisco_dot11_association_mib_cd11IfCipherStatsEntry_t *cd11IfCipherStatsEntry)
{
    guint8 idx = 14;

    if (vb->oid_len < idx) return -1;
    cd11IfCipherStatsEntry->ifIndex = vb->oid[idx++];
    if ((cd11IfCipherStatsEntry->ifIndex < 1)) {
         return -1;
    }
    if (vb->oid_len > idx) return -1;
    return 0;
...
static inline gint8
pack_cd11IfCipherStatsEntry(guint32 *base, gint32 ifIndex)
{
    guint8 idx = 14;
...
static inline cisco_dot11_association_mib_cd11IfCipherStatsEntry_t *
assign_cd11IfCipherStatsEntry(GList *vbl)
{
    cisco_dot11_association_mib_cd11IfCipherStatsEntry_t *cd11IfCipherStatsEntry;
    char *p;

    cd11IfCipherStatsEntry = cisco_dot11_association_mib_new_cd11IfCipherStatsEntry();
    p = (char *) cd11IfCipherStatsEntry + sizeof(cisco_dot11_association_mib_cd11IfCipherStatsEntry_t);
    * (GList **) p = vbl;

    if (unpack_cd11IfCipherStatsEntry((GNetSnmpVarBind *) vbl->data, cd11IfCipherStatsEntry) < 0) {
        g_warning("%s: invalid instance identifier", "cd11IfCipherStatsEntry");
        g_free(cd11IfCipherStatsEntry);
        return NULL;
    }

    gnet_snmp_attr_assign(vbl, cd11IfCipherStatsEntry_oid, G_N_ELEMENTS(cd11IfCipherStatsEntry_oid),
                      cd11IfCipherStatsEntry_attr, cd11IfCipherStatsEntry);
...
cisco_dot11_association_mib_get_cd11IfCipherStatsTable(GNetSnmp *s, cisco_dot11_association_mib_cd11IfCipherStatsEntry_t ***cd11IfCipherStatsEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 1, 4, 1, 0};
    guint32 base[128];

    *cd11IfCipherStatsEntry = NULL;
    memcpy(base, _base, sizeof(_base));

    gnet_snmp_attr_get(s, &in, base, 14, 13, cd11IfCipherStatsEntry_attr, mask);

    out = gnet_snmp_sync_table(s, in, error);
    /* gnet_snmp_varbind_list_free(in); */

    if (out) {
        *cd11IfCipherStatsEntry = (cisco_dot11_association_mib_cd11IfCipherStatsEntry_t **) g_malloc0((g_list_length(out) + 1) * sizeof(cisco_dot11_association_mib_cd11IfCipherStatsEntry_t *));
        for (row = out, i = 0; row; row = g_list_next(row), i++) {
            (*cd11IfCipherStatsEntry)[i] = assign_cd11IfCipherStatsEntry(row->data);
        }
    }
}
...
cisco_dot11_association_mib_get_cd11IfCipherStatsEntry(GNetSnmp *s, cisco_dot11_association_mib_cd11IfCipherStatsEntry_t **cd11IfCipherStatsEntry, gint32 ifIndex, gint64 mask, GError **error)
{
    ...
    memcpy(base, cd11IfCipherStatsEntry_oid, sizeof(cd11IfCipherStatsEntry_oid));
    len = pack_cd11IfCipherStatsEntry(base, ifIndex);
    if (len < 0) {
        g_warning("%s: invalid index values", "cd11IfCipherStatsEntry");
        s->error_status = GNET_SNMP_PDU_ERR_INTERNAL;
        return;
    }
    ...
    *cd11IfCipherStatsEntry = NULL;
    ...
    gnet_snmp_attr_get(s, &in, base, len, 13, cd11IfCipherStatsEntry_attr, mask);
    ...
    if (out) {
        ...
        *cd11IfCipherStatsEntry = assign_cd11IfCipherStatsEntry(out);
    }
}
...
cisco_dot11_association_mib_free_cd11IfCipherStatsTable(cisco_dot11_association_mib_cd11IfCipherStatsEntry_t **cd11IfCipherStatsEntry)
{
    ...
    if (cd11IfCipherStatsEntry) {
        for (i = 0; cd11IfCipherStatsEntry[i]; i++) {
            cisco_dot11_association_mib_free_cd11IfCipherStatsEntry(cd11IfCipherStatsEntry[i]);
        }
        g_free(cd11IfCipherStatsEntry);
    }
}
...
cisco_dot11_association_mib_get_cDot11ClientConfigInfoTable(GNetSnmp *s, cisco_dot11_association_mib_cDot11ClientConfigInfoEntry_t ***cDot11ClientConfigInfoEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 2, 1, 1, 0};
    guint32 base[128];
...
cisco_dot11_association_mib_get_cDot11ClientStatisticTable(GNetSnmp *s, cisco_dot11_association_mib_cDot11ClientStatisticEntry_t ***cDot11ClientStatisticEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 3, 1, 1, 0};
    guint32 base[128];
