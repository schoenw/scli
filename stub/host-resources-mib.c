...
static guint16 hrDeviceDescr_constraints[] = {0, 64, 0, 255, 0, 0};
...
static guint16 hrSWInstalledName_constraints[] = {0, 64, 0, 0};
static guint16 hrSWInstalledDate_constraints[] = {8, 8, 11, 11, 0, 0};
...
static GSnmpAttribute hrSWInstalled_attr[] = {
    { 1, G_SNMP_TIMETICKS,
...
static GSnmpAttribute hrSWInstalledEntry_attr[] = {
    { 2, G_SNMP_OCTETSTRING,
...
assign_hrSWInstalled(GSList *vbl)
{
    ...
    * (GSList **) p = vbl;
    ...
    gsnmp_attr_assign(vbl, hrSWInstalled_oid, sizeof(hrSWInstalled_oid)/sizeof(guint32),
...
host_resources_mib_get_hrSWInstalled(GSnmpSession *s, host_resources_mib_hrSWInstalled_t **hrSWInstalled, gint mask)
{
    ...
    *hrSWInstalled = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 9, 8, hrSWInstalled_attr, mask);
...
assign_hrSWInstalledEntry(GSList *vbl)
{
    ...
    * (GSList **) p = vbl;
    ...
    gsnmp_attr_assign(vbl, hrSWInstalledEntry_oid, sizeof(hrSWInstalledEntry_oid)/sizeof(guint32),
...
host_resources_mib_get_hrSWInstalledTable(GSnmpSession *s, host_resources_mib_hrSWInstalledEntry_t ***hrSWInstalledEntry, gint mask)
{
    ...
    *hrSWInstalledEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 11, 10, hrSWInstalledEntry_attr, mask);
...
host_resources_mib_get_hrSWInstalledEntry(GSnmpSession *s, host_resources_mib_hrSWInstalledEntry_t **hrSWInstalledEntry, gint32 hrSWInstalledIndex, gint mask)
{
    ...
    *hrSWInstalledEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, len, 10, hrSWInstalledEntry_attr, mask);
