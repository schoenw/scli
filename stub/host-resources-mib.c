...
static attribute_t attr_hrSystem[] = {
    ...
    { 2, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRSYSTEMDATE, "hrSystemDate" },
    { 3, G_SNMP_INTEGER32, HOST_RESOURCES_MIB_HRSYSTEMINITIALLOADDEVICE, "hrSystemInitialLoadDevice" },
    { 4, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRSYSTEMINITIALLOADPARAMETERS, "hrSystemInitialLoadParameters" },
...
static attribute_t attr_hrStorageEntry[] = {
    { 2, G_SNMP_OBJECTID, HOST_RESOURCES_MIB_HRSTORAGETYPE, "hrStorageType" },
    { 3, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRSTORAGEDESCR, "hrStorageDescr" },
...
static attribute_t attr_hrDeviceEntry[] = {
    { 2, G_SNMP_OBJECTID, HOST_RESOURCES_MIB_HRDEVICETYPE, "hrDeviceType" },
    { 3, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRDEVICEDESCR, "hrDeviceDescr" },
    { 4, G_SNMP_OBJECTID, HOST_RESOURCES_MIB_HRDEVICEID, "hrDeviceID" },
...
static attribute_t attr_hrProcessorEntry[] = {
    { 1, G_SNMP_OBJECTID, HOST_RESOURCES_MIB_HRPROCESSORFRWID, "hrProcessorFrwID" },
...
static attribute_t attr_hrPrinterEntry[] = {
    ...
    { 2, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRPRINTERDETECTEDERRORSTATE, "hrPrinterDetectedErrorState" },
    { 0, 0, 0, NULL }
};
...
static attribute_t attr_hrPartitionEntry[] = {
    { 2, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRPARTITIONLABEL, "hrPartitionLabel" },
    { 3, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRPARTITIONID, "hrPartitionID" },
...
static attribute_t attr_hrFSEntry[] = {
    { 2, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRFSMOUNTPOINT, "hrFSMountPoint" },
    { 3, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRFSREMOTEMOUNTPOINT, "hrFSRemoteMountPoint" },
    { 4, G_SNMP_OBJECTID, HOST_RESOURCES_MIB_HRFSTYPE, "hrFSType" },
    ...
    { 8, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRFSLASTFULLBACKUPDATE, "hrFSLastFullBackupDate" },
    { 9, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRFSLASTPARTIALBACKUPDATE, "hrFSLastPartialBackupDate" },
    { 0, 0, 0, NULL }
};
...
static attribute_t attr_hrSWRunEntry[] = {
    { 2, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRSWRUNNAME, "hrSWRunName" },
    { 3, G_SNMP_OBJECTID, HOST_RESOURCES_MIB_HRSWRUNID, "hrSWRunID" },
    { 4, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRSWRUNPATH, "hrSWRunPath" },
    { 5, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRSWRUNPARAMETERS, "hrSWRunParameters" },
...
static attribute_t attr_hrSWInstalledEntry[] = {
    { 2, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRSWINSTALLEDNAME, "hrSWInstalledName" },
    { 3, G_SNMP_OBJECTID, HOST_RESOURCES_MIB_HRSWINSTALLEDID, "hrSWInstalledID" },
    { 4, G_SNMP_INTEGER32, HOST_RESOURCES_MIB_HRSWINSTALLEDTYPE, "hrSWInstalledType" },
    { 5, G_SNMP_OCTETSTRING, HOST_RESOURCES_MIB_HRSWINSTALLEDDATE, "hrSWInstalledDate" },
    { 0, 0, 0, NULL }
};
