...
typedef struct {
    ...
    guint16  _snmpCommunityIndexLength;	/* (1..32) */
    guchar   *snmpCommunityName;
    guint16  _snmpCommunityNameLength;	/* (0..65535) */
    guchar   *snmpCommunitySecurityName;
    guint16  _snmpCommunitySecurityNameLength;	/* (1..32) */
    guchar   *snmpCommunityContextEngineID;
    guint16  _snmpCommunityContextEngineIDLength;	/* (5..32) */
    guchar   *snmpCommunityContextName;
    guint16  _snmpCommunityContextNameLength;	/* (0..32) */
    guchar   *snmpCommunityTransportTag;
    guint16  _snmpCommunityTransportTagLength;	/* (0..255) */
...
typedef struct {
    ...
    guint16  _snmpTargetAddrTMaskLength;	/* (0..255) */
