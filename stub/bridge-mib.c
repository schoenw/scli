...
static attribute_t attr_dot1dBase[] = {
    { 1, G_SNMP_OCTETSTRING, BRIDGE_MIB_DOT1DBASEBRIDGEADDRESS, "dot1dBaseBridgeAddress" },
...
static attribute_t attr_dot1dBasePortEntry[] = {
    ...
    { 3, G_SNMP_OBJECTID, BRIDGE_MIB_DOT1DBASEPORTCIRCUIT, "dot1dBasePortCircuit" },
...
static attribute_t attr_dot1dStp[] = {
    ...
    { 5, G_SNMP_OCTETSTRING, BRIDGE_MIB_DOT1DSTPDESIGNATEDROOT, "dot1dStpDesignatedRoot" },
...
static attribute_t attr_dot1dStpPortEntry[] = {
    ...
    { 6, G_SNMP_OCTETSTRING, BRIDGE_MIB_DOT1DSTPPORTDESIGNATEDROOT, "dot1dStpPortDesignatedRoot" },
    { 7, G_SNMP_INTEGER32, BRIDGE_MIB_DOT1DSTPPORTDESIGNATEDCOST, "dot1dStpPortDesignatedCost" },
    { 8, G_SNMP_OCTETSTRING, BRIDGE_MIB_DOT1DSTPPORTDESIGNATEDBRIDGE, "dot1dStpPortDesignatedBridge" },
    { 9, G_SNMP_OCTETSTRING, BRIDGE_MIB_DOT1DSTPPORTDESIGNATEDPORT, "dot1dStpPortDesignatedPort" },
...
static attribute_t attr_dot1dStaticEntry[] = {
    { 3, G_SNMP_OCTETSTRING, BRIDGE_MIB_DOT1DSTATICALLOWEDTOGOTO, "dot1dStaticAllowedToGoTo" },
