...
GSnmpEnum const rs_232_mib_enums_rs232PortType[] = {
...
GSnmpEnum const rs_232_mib_enums_rs232PortInFlowType[] = {
...
GSnmpEnum const rs_232_mib_enums_rs232PortOutFlowType[] = {
...
GSnmpEnum const rs_232_mib_enums_rs232AsyncPortStopBits[] = {
...
GSnmpEnum const rs_232_mib_enums_rs232AsyncPortParity[] = {
...
GSnmpEnum const rs_232_mib_enums_rs232AsyncPortAutobaud[] = {
    { RS_232_MIB_RS232ASYNCPORTAUTOBAUD_ENABLED,  "enabled" },
    { RS_232_MIB_RS232ASYNCPORTAUTOBAUD_DISABLED, "disabled" },
    { 0, NULL }
};

GSnmpEnum const rs_232_mib_enums_rs232SyncPortClockSource[] = {
...
GSnmpEnum const rs_232_mib_enums_rs232SyncPortIdlePattern[] = {
    { RS_232_MIB_RS232SYNCPORTIDLEPATTERN_MARK,  "mark" },
    { RS_232_MIB_RS232SYNCPORTIDLEPATTERN_SPACE, "space" },
    { 0, NULL }
};

GSnmpEnum const rs_232_mib_enums_rs232InSigName[] = {
...
GSnmpEnum const rs_232_mib_enums_rs232InSigState[] = {
...
GSnmpEnum const rs_232_mib_enums_rs232OutSigName[] = {
...
GSnmpEnum const rs_232_mib_enums_rs232OutSigState[] = {
...
static guint32 rs232AsyncPortBits_constraints[] = {5L, 8L, 0, 0};


static guint32 const rs232_oid[] = {1, 3, 6, 1, 2, 1, 10, 33};

static GSnmpAttribute rs232_attr[] = {
    { 1, G_SNMP_INTEGER32,
...
static GSnmpAttribute rs232PortEntry_attr[] = {
    { 2, G_SNMP_INTEGER32,
...
static GSnmpAttribute rs232AsyncPortEntry_attr[] = {
    { 2, G_SNMP_INTEGER32,
...
static GSnmpAttribute rs232SyncPortEntry_attr[] = {
    { 2, G_SNMP_INTEGER32,
...
static GSnmpAttribute rs232InSigEntry_attr[] = {
    { 3, G_SNMP_INTEGER32,
...
static GSnmpAttribute rs232OutSigEntry_attr[] = {
    { 3, G_SNMP_INTEGER32,
...
static rs_232_mib_rs232_t *
assign_rs232(GSList *vbl)
{
    rs_232_mib_rs232_t *rs232;
    char *p;
    ...
    * (GSList **) p = vbl;
    ...
    gsnmp_attr_assign(vbl, rs232_oid, sizeof(rs232_oid)/sizeof(guint32),
                      rs232_attr, rs232);
...
rs_232_mib_get_rs232(GSnmpSession *s, rs_232_mib_rs232_t **rs232, gint mask)
{
    ...
    *rs232 = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 9, 8, rs232_attr, mask);
...
static int
unpack_rs232PortEntry(GSnmpVarBind *vb, rs_232_mib_rs232PortEntry_t *rs232PortEntry)
{
    guint8 idx = 11;

    if (vb->id_len < idx) return -1;
    rs232PortEntry->rs232PortIndex = vb->id[idx++];
    if (vb->id_len > idx) return -1;
    return 0;
}
...
static rs_232_mib_rs232PortEntry_t *
assign_rs232PortEntry(GSList *vbl)
{
    rs_232_mib_rs232PortEntry_t *rs232PortEntry;
    char *p;
    ...
    * (GSList **) p = vbl;
    ...
    if (unpack_rs232PortEntry((GSnmpVarBind *) vbl->data, rs232PortEntry) < 0) {
        g_warning("%s: invalid instance identifier", "rs232PortEntry");
        g_free(rs232PortEntry);
        return NULL;
    }

    gsnmp_attr_assign(vbl, rs232PortEntry_oid, sizeof(rs232PortEntry_oid)/sizeof(guint32),
...
rs_232_mib_get_rs232PortTable(GSnmpSession *s, rs_232_mib_rs232PortEntry_t ***rs232PortEntry, gint mask)
{
    ...
    *rs232PortEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 11, 10, rs232PortEntry_attr, mask);

    out = gsnmp_gettable(s, in);
    /* g_snmp_vbl_free(in); */

    if (out) {
        *rs232PortEntry = (rs_232_mib_rs232PortEntry_t **) g_malloc0((g_slist_length(out) + 1) * sizeof(rs_232_mib_rs232PortEntry_t *));
        if (! *rs232PortEntry) {
...
rs_232_mib_get_rs232PortEntry(GSnmpSession *s, rs_232_mib_rs232PortEntry_t **rs232PortEntry, gint32 rs232PortIndex, gint mask)
{
    ...
    *rs232PortEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, len, 10, rs232PortEntry_attr, mask);
...
rs_232_mib_set_rs232PortEntry(GSnmpSession *s, rs_232_mib_rs232PortEntry_t *rs232PortEntry, gint mask)
{
    ...
    gsnmp_attr_set(s, &in, base, len, 10, rs232PortEntry_attr, mask, rs232PortEntry);
...
static int
unpack_rs232AsyncPortEntry(GSnmpVarBind *vb, rs_232_mib_rs232AsyncPortEntry_t *rs232AsyncPortEntry)
{
    guint8 idx = 11;

    if (vb->id_len < idx) return -1;
    rs232AsyncPortEntry->rs232AsyncPortIndex = vb->id[idx++];
    if (vb->id_len > idx) return -1;
    return 0;
}
...
static rs_232_mib_rs232AsyncPortEntry_t *
assign_rs232AsyncPortEntry(GSList *vbl)
{
    rs_232_mib_rs232AsyncPortEntry_t *rs232AsyncPortEntry;
    char *p;
    ...
    * (GSList **) p = vbl;
    ...
    if (unpack_rs232AsyncPortEntry((GSnmpVarBind *) vbl->data, rs232AsyncPortEntry) < 0) {
        g_warning("%s: invalid instance identifier", "rs232AsyncPortEntry");
        g_free(rs232AsyncPortEntry);
        return NULL;
    }

    gsnmp_attr_assign(vbl, rs232AsyncPortEntry_oid, sizeof(rs232AsyncPortEntry_oid)/sizeof(guint32),
...
rs_232_mib_get_rs232AsyncPortTable(GSnmpSession *s, rs_232_mib_rs232AsyncPortEntry_t ***rs232AsyncPortEntry, gint mask)
{
    ...
    *rs232AsyncPortEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 11, 10, rs232AsyncPortEntry_attr, mask);

    out = gsnmp_gettable(s, in);
    /* g_snmp_vbl_free(in); */

    if (out) {
        *rs232AsyncPortEntry = (rs_232_mib_rs232AsyncPortEntry_t **) g_malloc0((g_slist_length(out) + 1) * sizeof(rs_232_mib_rs232AsyncPortEntry_t *));
        if (! *rs232AsyncPortEntry) {
            s->error_status = G_SNMP_ERR_INTERNAL;
            g_snmp_vbl_free(out);
            return;
...
rs_232_mib_get_rs232AsyncPortEntry(GSnmpSession *s, rs_232_mib_rs232AsyncPortEntry_t **rs232AsyncPortEntry, gint32 rs232AsyncPortIndex, gint mask)
{
    ...
    *rs232AsyncPortEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, len, 10, rs232AsyncPortEntry_attr, mask);
...
rs_232_mib_set_rs232AsyncPortEntry(GSnmpSession *s, rs_232_mib_rs232AsyncPortEntry_t *rs232AsyncPortEntry, gint mask)
{
    ...
    gsnmp_attr_set(s, &in, base, len, 10, rs232AsyncPortEntry_attr, mask, rs232AsyncPortEntry);
...
static int
unpack_rs232SyncPortEntry(GSnmpVarBind *vb, rs_232_mib_rs232SyncPortEntry_t *rs232SyncPortEntry)
{
    guint8 idx = 11;

    if (vb->id_len < idx) return -1;
    rs232SyncPortEntry->rs232SyncPortIndex = vb->id[idx++];
    if (vb->id_len > idx) return -1;
    return 0;
}
...
static rs_232_mib_rs232SyncPortEntry_t *
assign_rs232SyncPortEntry(GSList *vbl)
{
    rs_232_mib_rs232SyncPortEntry_t *rs232SyncPortEntry;
    char *p;
    ...
    * (GSList **) p = vbl;
    ...
    if (unpack_rs232SyncPortEntry((GSnmpVarBind *) vbl->data, rs232SyncPortEntry) < 0) {
        g_warning("%s: invalid instance identifier", "rs232SyncPortEntry");
        g_free(rs232SyncPortEntry);
        return NULL;
    }

    gsnmp_attr_assign(vbl, rs232SyncPortEntry_oid, sizeof(rs232SyncPortEntry_oid)/sizeof(guint32),
...
rs_232_mib_get_rs232SyncPortTable(GSnmpSession *s, rs_232_mib_rs232SyncPortEntry_t ***rs232SyncPortEntry, gint mask)
{
    ...
    *rs232SyncPortEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 11, 10, rs232SyncPortEntry_attr, mask);

    out = gsnmp_gettable(s, in);
    /* g_snmp_vbl_free(in); */

    if (out) {
        *rs232SyncPortEntry = (rs_232_mib_rs232SyncPortEntry_t **) g_malloc0((g_slist_length(out) + 1) * sizeof(rs_232_mib_rs232SyncPortEntry_t *));
        if (! *rs232SyncPortEntry) {
            s->error_status = G_SNMP_ERR_INTERNAL;
            g_snmp_vbl_free(out);
            return;
...
rs_232_mib_get_rs232SyncPortEntry(GSnmpSession *s, rs_232_mib_rs232SyncPortEntry_t **rs232SyncPortEntry, gint32 rs232SyncPortIndex, gint mask)
{
    ...
    *rs232SyncPortEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, len, 10, rs232SyncPortEntry_attr, mask);
...
rs_232_mib_set_rs232SyncPortEntry(GSnmpSession *s, rs_232_mib_rs232SyncPortEntry_t *rs232SyncPortEntry, gint mask)
{
    ...
    gsnmp_attr_set(s, &in, base, len, 10, rs232SyncPortEntry_attr, mask, rs232SyncPortEntry);
...
static int
unpack_rs232InSigEntry(GSnmpVarBind *vb, rs_232_mib_rs232InSigEntry_t *rs232InSigEntry)
{
    guint8 idx = 11;

    if (vb->id_len < idx) return -1;
    rs232InSigEntry->rs232InSigPortIndex = vb->id[idx++];
    if (vb->id_len < idx) return -1;
    rs232InSigEntry->rs232InSigName = vb->id[idx++];
    if (vb->id_len > idx) return -1;
    return 0;
}
...
static rs_232_mib_rs232InSigEntry_t *
assign_rs232InSigEntry(GSList *vbl)
{
    rs_232_mib_rs232InSigEntry_t *rs232InSigEntry;
    char *p;
    ...
    * (GSList **) p = vbl;
    ...
    if (unpack_rs232InSigEntry((GSnmpVarBind *) vbl->data, rs232InSigEntry) < 0) {
        g_warning("%s: invalid instance identifier", "rs232InSigEntry");
        g_free(rs232InSigEntry);
        return NULL;
    }

    gsnmp_attr_assign(vbl, rs232InSigEntry_oid, sizeof(rs232InSigEntry_oid)/sizeof(guint32),
...
rs_232_mib_get_rs232InSigTable(GSnmpSession *s, rs_232_mib_rs232InSigEntry_t ***rs232InSigEntry, gint mask)
{
    ...
    *rs232InSigEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 11, 10, rs232InSigEntry_attr, mask);

    out = gsnmp_gettable(s, in);
    /* g_snmp_vbl_free(in); */

    if (out) {
        *rs232InSigEntry = (rs_232_mib_rs232InSigEntry_t **) g_malloc0((g_slist_length(out) + 1) * sizeof(rs_232_mib_rs232InSigEntry_t *));
        if (! *rs232InSigEntry) {
            s->error_status = G_SNMP_ERR_INTERNAL;
            g_snmp_vbl_free(out);
            return;
...
rs_232_mib_get_rs232InSigEntry(GSnmpSession *s, rs_232_mib_rs232InSigEntry_t **rs232InSigEntry, gint32 rs232InSigPortIndex, gint32 rs232InSigName, gint mask)
{
    ...
    *rs232InSigEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, len, 10, rs232InSigEntry_attr, mask);
...
static int
unpack_rs232OutSigEntry(GSnmpVarBind *vb, rs_232_mib_rs232OutSigEntry_t *rs232OutSigEntry)
{
    guint8 idx = 11;

    if (vb->id_len < idx) return -1;
    rs232OutSigEntry->rs232OutSigPortIndex = vb->id[idx++];
    if (vb->id_len < idx) return -1;
    rs232OutSigEntry->rs232OutSigName = vb->id[idx++];
    if (vb->id_len > idx) return -1;
    return 0;
}
...
static rs_232_mib_rs232OutSigEntry_t *
assign_rs232OutSigEntry(GSList *vbl)
{
    rs_232_mib_rs232OutSigEntry_t *rs232OutSigEntry;
    char *p;
    ...
    * (GSList **) p = vbl;
    ...
    if (unpack_rs232OutSigEntry((GSnmpVarBind *) vbl->data, rs232OutSigEntry) < 0) {
        g_warning("%s: invalid instance identifier", "rs232OutSigEntry");
        g_free(rs232OutSigEntry);
        return NULL;
    }

    gsnmp_attr_assign(vbl, rs232OutSigEntry_oid, sizeof(rs232OutSigEntry_oid)/sizeof(guint32),
...
rs_232_mib_get_rs232OutSigTable(GSnmpSession *s, rs_232_mib_rs232OutSigEntry_t ***rs232OutSigEntry, gint mask)
{
    ...
    *rs232OutSigEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 11, 10, rs232OutSigEntry_attr, mask);

    out = gsnmp_gettable(s, in);
    /* g_snmp_vbl_free(in); */

    if (out) {
        *rs232OutSigEntry = (rs_232_mib_rs232OutSigEntry_t **) g_malloc0((g_slist_length(out) + 1) * sizeof(rs_232_mib_rs232OutSigEntry_t *));
        if (! *rs232OutSigEntry) {
            s->error_status = G_SNMP_ERR_INTERNAL;
            g_snmp_vbl_free(out);
            return;
...
rs_232_mib_get_rs232OutSigEntry(GSnmpSession *s, rs_232_mib_rs232OutSigEntry_t **rs232OutSigEntry, gint32 rs232OutSigPortIndex, gint32 rs232OutSigName, gint mask)
{
    ...
    *rs232OutSigEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, len, 10, rs232OutSigEntry_attr, mask);
