...
extern void
disman_schedule_mib_get_schedObjects(GNetSnmp *s, disman_schedule_mib_schedObjects_t **schedObjects, gint64 mask);
...
extern void
disman_schedule_mib_get_schedTable(GNetSnmp *s, disman_schedule_mib_schedEntry_t ***schedEntry, gint64 mask);
...
extern void
disman_schedule_mib_get_schedEntry(GNetSnmp *s, disman_schedule_mib_schedEntry_t **schedEntry, guchar *schedOwner, guint16 _schedOwnerLength, guchar *schedName, guint16 _schedNameLength, gint64 mask);

extern void
disman_schedule_mib_set_schedEntry(GNetSnmp *s, disman_schedule_mib_schedEntry_t *schedEntry, gint64 mask);
