...
typedef struct {
    guchar   *sysDescr;
    guint16  _sysDescrLength;	/* (0..255) */
    guint32  *sysObjectID;
    guint16  _sysObjectIDLength;	/* (0..128) */
    guint32  *sysUpTime;
    guchar   *sysContact;
    guint16  _sysContactLength;	/* (0..255) */
    guchar   *sysName;
    guint16  _sysNameLength;	/* (0..255) */
    guchar   *sysLocation;
    guint16  _sysLocationLength;	/* (0..255) */
    gint32   *sysServices;
...
typedef struct {
    gint32   sysORIndex;
    guint32  *sysORID;
    guint16  _sysORIDLength;	/* (0..128) */
    guchar   *sysORDescr;
    guint16  _sysORDescrLength;	/* (0..255) */
    guint32  *sysORUpTime;
