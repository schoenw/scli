...
extern void
snmpv2_mib_get_system(GSnmpSession *s, snmpv2_mib_system_t **system, gint64 mask);

extern void
snmpv2_mib_set_system(GSnmpSession *s, snmpv2_mib_system_t *system, gint64 mask);
...
extern void
snmpv2_mib_get_sysORTable(GSnmpSession *s, snmpv2_mib_sysOREntry_t ***sysOREntry, gint64 mask);
...
extern void
snmpv2_mib_get_sysOREntry(GSnmpSession *s, snmpv2_mib_sysOREntry_t **sysOREntry, gint32 sysORIndex, gint64 mask);
...
extern void
snmpv2_mib_get_snmp(GSnmpSession *s, snmpv2_mib_snmp_t **snmp, gint64 mask);

extern void
snmpv2_mib_set_snmp(GSnmpSession *s, snmpv2_mib_snmp_t *snmp, gint64 mask);
...
extern void
snmpv2_mib_get_snmpSet(GSnmpSession *s, snmpv2_mib_snmpSet_t **snmpSet, gint64 mask);

extern void
snmpv2_mib_set_snmpSet(GSnmpSession *s, snmpv2_mib_snmpSet_t *snmpSet, gint64 mask);
