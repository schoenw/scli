...
#define MAU_MIB_BROADMAUIFINDEX         (1 << 0) 
#define MAU_MIB_BROADMAUINDEX           (1 << 1) 
#define MAU_MIB_BROADMAUXMTRCVSPLITTYPE (1 << 2) 
#define MAU_MIB_BROADMAUXMTCARRIERFREQ  (1 << 3) 
#define MAU_MIB_BROADMAUTRANSLATIONFREQ (1 << 4) 
