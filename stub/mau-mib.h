...
extern GSnmpEnum const mau_mib_enums_JackType[];
...
typedef struct {
    ...
    guint32  *rpMauType;                         /* ro ObjectIdentifier */
...
typedef struct {
    gint32   ifMauIfIndex;                       /* ro */
    gint32   ifMauIndex;                         /* ro */
    guint32  *ifMauType;                         /* ro ObjectIdentifier */
...
#define MAU_MIB_IFMAUTYPEMAXLENGTH 128
    ...
    guint32  *ifMauDefaultType;                  /* rw ObjectIdentifier */
...
#define MAU_MIB_IFMAUTYPELISTBITSMAXLENGTH 4
