...
static int
pack_schedEntry(guint32 *base, guchar *schedOwner, gsize _schedOwnerLength, guchar *schedName, gsize _schedNameLength)
{
    int i, len, idx = 11;
...
void
disman_schedule_mib_get_schedEntry(GSnmpSession *s, disman_schedule_mib_schedEntry_t **schedEntry, guchar *schedOwner, gsize _schedOwnerLength, guchar *schedName, gsize _schedNameLength, gint mask)
{
    GSList *in = NULL, *out = NULL;
    guint32 base[128];
    int len;
