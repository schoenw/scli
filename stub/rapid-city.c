...
static attribute_t attr_rcVlanEntry[] = {
    { 2, G_SNMP_OCTETSTRING, RAPID_CITY_RCVLANNAME, "rcVlanName" },
    ...
    { 11, G_SNMP_OCTETSTRING, RAPID_CITY_RCVLANPORTMEMBERS, "rcVlanPortMembers" },
    { 12, G_SNMP_OCTETSTRING, RAPID_CITY_RCVLANACTIVEMEMBERS, "rcVlanActiveMembers" },
    { 13, G_SNMP_OCTETSTRING, RAPID_CITY_RCVLANSTATICMEMBERS, "rcVlanStaticMembers" },
    { 14, G_SNMP_OCTETSTRING, RAPID_CITY_RCVLANNOTALLOWTOJOIN, "rcVlanNotAllowToJoin" },
    ...
    { 19, G_SNMP_OCTETSTRING, RAPID_CITY_RCVLANMACADDRESS, "rcVlanMacAddress" },
    ...
    { 25, G_SNMP_OCTETSTRING, RAPID_CITY_RCVLANIGMPSNOOPMROUTERPORTS, "rcVlanIgmpSnoopMRouterPorts" },
    { 26, G_SNMP_INTEGER32, RAPID_CITY_RCVLANUSERDEFINEDPID, "rcVlanUserDefinedPid" },
    { 27, G_SNMP_OCTETSTRING, RAPID_CITY_RCVLANIGMPSNOOPACTIVEMROUTERPORTS, "rcVlanIgmpSnoopActiveMRouterPorts" },
...
static attribute_t attr_rcVlanPortEntry[] = {
    ...
    { 3, G_SNMP_OCTETSTRING, RAPID_CITY_RCVLANPORTVLANIDS, "rcVlanPortVlanIds" },
