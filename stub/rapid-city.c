...
void
rapid_city_get_rcVlanTable(GNetSnmp *s, rapid_city_rcVlanEntry_t ***rcVlanEntry, gint64 mask, GError **error)
{
...
void
rapid_city_get_rcVlanEntry(GNetSnmp *s, rapid_city_rcVlanEntry_t **rcVlanEntry, gint32 rcVlanId, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
...
void
rapid_city_set_rcVlanEntry(GNetSnmp *s, rapid_city_rcVlanEntry_t *rcVlanEntry, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
...
void
rapid_city_get_rcVlanPortTable(GNetSnmp *s, rapid_city_rcVlanPortEntry_t ***rcVlanPortEntry, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
...
void
rapid_city_get_rcVlanPortEntry(GNetSnmp *s, rapid_city_rcVlanPortEntry_t **rcVlanPortEntry, gint32 rcVlanPortIndex, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
...
void
rapid_city_set_rcVlanPortEntry(GNetSnmp *s, rapid_city_rcVlanPortEntry_t *rcVlanPortEntry, gint64 mask, GError **error)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
