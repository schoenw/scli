...
cisco_process_mib_get_cpmCPUTotalTable(GNetSnmp *s, cisco_process_mib_cpmCPUTotalEntry_t ***cpmCPUTotalEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 9, 9, 109, 1, 1, 1, 1, 0};
    guint32 base[128];
...
cisco_process_mib_get_cpmProcessTable(GNetSnmp *s, cisco_process_mib_cpmProcessEntry_t ***cpmProcessEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 9, 9, 109, 1, 2, 1, 1, 0};
    guint32 base[128];
...
cisco_process_mib_get_cpmProcessExtTable(GNetSnmp *s, cisco_process_mib_cpmProcessExtEntry_t ***cpmProcessExtEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 9, 9, 109, 1, 2, 2, 1, 0};
    guint32 base[128];
...
cisco_process_mib_get_cpmProcessExtRevTable(GNetSnmp *s, cisco_process_mib_cpmProcessExtRevEntry_t ***cpmProcessExtRevEntry, gint64 mask, GError **error)
{
    ...
    GList *row;
    int i;
    static guint32 const _base[] = {1, 3, 6, 1, 4, 1, 9, 9, 109, 1, 2, 3, 1, 0};
    guint32 base[128];
