...
GSnmpEnum const cisco_process_mib_enums_cpmProcExtPriority[] = {
...
GSnmpEnum const cisco_process_mib_enums_cpmProcExtPriorityRev[] = {
...
static GSnmpAttribute cpmCPUTotalEntry_attr[] = {
...
static GSnmpAttribute cpmProcessEntry_attr[] = {
...
static GSnmpAttribute cpmProcessExtEntry_attr[] = {
...
static GSnmpAttribute cpmProcessExtRevEntry_attr[] = {
    { 1, GNET_SNMP_VARBIND_TYPE_UNSIGNED32,
...
assign_cpmCPUTotalEntry(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gsnmp_attr_assign(vbl, cpmCPUTotalEntry_oid, sizeof(cpmCPUTotalEntry_oid)/sizeof(guint32),
...
void
cisco_process_mib_get_cpmCPUTotalTable(GSnmpSession *s, cisco_process_mib_cpmCPUTotalEntry_t ***cpmCPUTotalEntry, gint64 mask)
{
    ...
    *cpmCPUTotalEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 14, 13, cpmCPUTotalEntry_attr, mask);
...
void
cisco_process_mib_get_cpmCPUTotalEntry(GSnmpSession *s, cisco_process_mib_cpmCPUTotalEntry_t **cpmCPUTotalEntry, guint32 cpmCPUTotalIndex, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
    ...
    *cpmCPUTotalEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, len, 13, cpmCPUTotalEntry_attr, mask);
...
assign_cpmProcessEntry(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gsnmp_attr_assign(vbl, cpmProcessEntry_oid, sizeof(cpmProcessEntry_oid)/sizeof(guint32),
...
void
cisco_process_mib_get_cpmProcessTable(GSnmpSession *s, cisco_process_mib_cpmProcessEntry_t ***cpmProcessEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
    ...
    *cpmProcessEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 14, 13, cpmProcessEntry_attr, mask);
...
void
cisco_process_mib_get_cpmProcessEntry(GSnmpSession *s, cisco_process_mib_cpmProcessEntry_t **cpmProcessEntry, guint32 cpmCPUTotalIndex, guint32 cpmProcessPID, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
    ...
    *cpmProcessEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, len, 13, cpmProcessEntry_attr, mask);
...
assign_cpmProcessExtEntry(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gsnmp_attr_assign(vbl, cpmProcessExtEntry_oid, sizeof(cpmProcessExtEntry_oid)/sizeof(guint32),
...
void
cisco_process_mib_get_cpmProcessExtTable(GSnmpSession *s, cisco_process_mib_cpmProcessExtEntry_t ***cpmProcessExtEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
    ...
    *cpmProcessExtEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 14, 13, cpmProcessExtEntry_attr, mask);
...
void
cisco_process_mib_get_cpmProcessExtEntry(GSnmpSession *s, cisco_process_mib_cpmProcessExtEntry_t **cpmProcessExtEntry, guint32 cpmCPUTotalIndex, guint32 cpmProcessPID, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
    ...
    *cpmProcessExtEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, len, 13, cpmProcessExtEntry_attr, mask);
...
void
cisco_process_mib_set_cpmProcessExtEntry(GSnmpSession *s, cisco_process_mib_cpmProcessExtEntry_t *cpmProcessExtEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
    ...
    gsnmp_attr_set(s, &in, base, len, 13, cpmProcessExtEntry_attr, mask, cpmProcessExtEntry);
...
assign_cpmProcessExtRevEntry(GList *vbl)
{
    ...
    * (GList **) p = vbl;
    ...
    gsnmp_attr_assign(vbl, cpmProcessExtRevEntry_oid, sizeof(cpmProcessExtRevEntry_oid)/sizeof(guint32),
...
void
cisco_process_mib_get_cpmProcessExtRevTable(GSnmpSession *s, cisco_process_mib_cpmProcessExtRevEntry_t ***cpmProcessExtRevEntry, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    GList *row;
    int i;
    ...
    *cpmProcessExtRevEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, 14, 13, cpmProcessExtRevEntry_attr, mask);
...
void
cisco_process_mib_get_cpmProcessExtRevEntry(GSnmpSession *s, cisco_process_mib_cpmProcessExtRevEntry_t **cpmProcessExtRevEntry, guint32 cpmCPUTotalIndex, guint32 cpmProcessPID, gint64 mask)
{
    GList *in = NULL, *out = NULL;
    guint32 base[128];
    gint8 len;
    ...
    *cpmProcessExtRevEntry = NULL;
    ...
    gsnmp_attr_get(s, &in, base, len, 13, cpmProcessExtRevEntry_attr, mask);
