...
disman_script_mib_set_smScriptDescr(GSnmpSession *s, guchar *smScriptOwner, guint16 _smScriptOwnerLength, guchar *smScriptName, guint16 _smScriptNameLength, guchar *smScriptDescr, guint16 _smScriptDescrLength)
{
    ...
    disman_script_mib_get_smScriptEntry(s, &smScriptEntry, smScriptOwner, _smScriptOwnerLength, smScriptName, _smScriptNameLength, DISMAN_SCRIPT_MIB_SMSCRIPTDESCR);
    if (s->error_status || !smScriptEntry) return;
    smScriptEntry->smScriptDescr = smScriptDescr;
    smScriptEntry->_smScriptDescrLength = _smScriptDescrLength;
    disman_script_mib_set_smScriptEntry(s, smScriptEntry, DISMAN_SCRIPT_MIB_SMSCRIPTDESCR);
...
disman_script_mib_set_smScriptLanguage(GSnmpSession *s, guchar *smScriptOwner, guint16 _smScriptOwnerLength, guchar *smScriptName, guint16 _smScriptNameLength, gint32 smScriptLanguage)
{
    ...
    disman_script_mib_get_smScriptEntry(s, &smScriptEntry, smScriptOwner, _smScriptOwnerLength, smScriptName, _smScriptNameLength, DISMAN_SCRIPT_MIB_SMSCRIPTLANGUAGE);
    if (s->error_status || !smScriptEntry) return;
    smScriptEntry->smScriptLanguage = &smScriptLanguage;
    disman_script_mib_set_smScriptEntry(s, smScriptEntry, DISMAN_SCRIPT_MIB_SMSCRIPTLANGUAGE);
    disman_script_mib_free_smScriptEntry(smScriptEntry);
}
...
disman_script_mib_set_smScriptSource(GSnmpSession *s, guchar *smScriptOwner, guint16 _smScriptOwnerLength, guchar *smScriptName, guint16 _smScriptNameLength, guchar *smScriptSource, guint16 _smScriptSourceLength)
{
    ...
    disman_script_mib_get_smScriptEntry(s, &smScriptEntry, smScriptOwner, _smScriptOwnerLength, smScriptName, _smScriptNameLength, DISMAN_SCRIPT_MIB_SMSCRIPTSOURCE);
    if (s->error_status || !smScriptEntry) return;
    smScriptEntry->smScriptSource = smScriptSource;
    smScriptEntry->_smScriptSourceLength = _smScriptSourceLength;
    disman_script_mib_set_smScriptEntry(s, smScriptEntry, DISMAN_SCRIPT_MIB_SMSCRIPTSOURCE);
    disman_script_mib_free_smScriptEntry(smScriptEntry);
}
...
disman_script_mib_set_smScriptAdminStatus(GSnmpSession *s, guchar *smScriptOwner, guint16 _smScriptOwnerLength, guchar *smScriptName, guint16 _smScriptNameLength, gint32 smScriptAdminStatus)
{
    ...
    disman_script_mib_get_smScriptEntry(s, &smScriptEntry, smScriptOwner, _smScriptOwnerLength, smScriptName, _smScriptNameLength, DISMAN_SCRIPT_MIB_SMSCRIPTADMINSTATUS);
    if (s->error_status || !smScriptEntry) return;
    smScriptEntry->smScriptAdminStatus = &smScriptAdminStatus;
    disman_script_mib_set_smScriptEntry(s, smScriptEntry, DISMAN_SCRIPT_MIB_SMSCRIPTADMINSTATUS);
    disman_script_mib_free_smScriptEntry(smScriptEntry);
}
...
disman_script_mib_set_smScriptStorageType(GSnmpSession *s, guchar *smScriptOwner, guint16 _smScriptOwnerLength, guchar *smScriptName, guint16 _smScriptNameLength, gint32 smScriptStorageType)
{
    ...
    disman_script_mib_get_smScriptEntry(s, &smScriptEntry, smScriptOwner, _smScriptOwnerLength, smScriptName, _smScriptNameLength, DISMAN_SCRIPT_MIB_SMSCRIPTSTORAGETYPE);
    if (s->error_status || !smScriptEntry) return;
    smScriptEntry->smScriptStorageType = &smScriptStorageType;
    disman_script_mib_set_smScriptEntry(s, smScriptEntry, DISMAN_SCRIPT_MIB_SMSCRIPTSTORAGETYPE);
    disman_script_mib_free_smScriptEntry(smScriptEntry);
}
...
{
    disman_script_mib_smScriptEntry_t *smScriptEntry;
    gint32 create = DISMAN_SCRIPT_MIB_SMSCRIPTROWSTATUS_CREATEANDGO;

    smScriptEntry = disman_script_mib_new_smScriptEntry();
    memcpy(smScriptEntry->smScriptOwner, smScriptOwner, _smScriptOwnerLength);
    memcpy(smScriptEntry->smScriptName, smScriptName, _smScriptNameLength);
    smScriptEntry->smScriptRowStatus = &create;
    disman_script_mib_set_smScriptEntry(s, smScriptEntry, DISMAN_SCRIPT_MIB_SMSCRIPTROWSTATUS);
    disman_script_mib_free_smScriptEntry(smScriptEntry);
}
...
{
    disman_script_mib_smScriptEntry_t *smScriptEntry;
    gint32 destroy = DISMAN_SCRIPT_MIB_SMSCRIPTROWSTATUS_DESTROY;

    disman_script_mib_get_smScriptEntry(s, &smScriptEntry, smScriptOwner, _smScriptOwnerLength, smScriptName, _smScriptNameLength, DISMAN_SCRIPT_MIB_SMSCRIPTROWSTATUS);
    if (s->error_status || !smScriptEntry) return;
    smScriptEntry->smScriptRowStatus = &destroy;
    disman_script_mib_set_smScriptEntry(s, smScriptEntry, DISMAN_SCRIPT_MIB_SMSCRIPTROWSTATUS);
    disman_script_mib_free_smScriptEntry(smScriptEntry);
}
...
disman_script_mib_set_smLaunchScriptOwner(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, guchar *smLaunchScriptOwner, guint16 _smLaunchScriptOwnerLength)
{
    ...
    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHSCRIPTOWNER);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchScriptOwner = smLaunchScriptOwner;
    smLaunchEntry->_smLaunchScriptOwnerLength = _smLaunchScriptOwnerLength;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHSCRIPTOWNER);
...
disman_script_mib_set_smLaunchScriptName(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, guchar *smLaunchScriptName, guint16 _smLaunchScriptNameLength)
{
    ...
    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHSCRIPTNAME);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchScriptName = smLaunchScriptName;
    smLaunchEntry->_smLaunchScriptNameLength = _smLaunchScriptNameLength;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHSCRIPTNAME);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
disman_script_mib_set_smLaunchArgument(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, guchar *smLaunchArgument, guint16 _smLaunchArgumentLength)
{
    ...
    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHARGUMENT);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchArgument = smLaunchArgument;
    smLaunchEntry->_smLaunchArgumentLength = _smLaunchArgumentLength;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHARGUMENT);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
disman_script_mib_set_smLaunchMaxRunning(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, guint32 smLaunchMaxRunning)
{
    ...
    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHMAXRUNNING);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchMaxRunning = &smLaunchMaxRunning;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHMAXRUNNING);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
disman_script_mib_set_smLaunchMaxCompleted(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, guint32 smLaunchMaxCompleted)
{
    ...
    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHMAXCOMPLETED);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchMaxCompleted = &smLaunchMaxCompleted;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHMAXCOMPLETED);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
disman_script_mib_set_smLaunchLifeTime(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, gint32 smLaunchLifeTime)
{
    ...
    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHLIFETIME);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchLifeTime = &smLaunchLifeTime;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHLIFETIME);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
disman_script_mib_set_smLaunchExpireTime(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, gint32 smLaunchExpireTime)
{
    ...
    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHEXPIRETIME);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchExpireTime = &smLaunchExpireTime;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHEXPIRETIME);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
disman_script_mib_set_smLaunchStart(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, gint32 smLaunchStart)
{
    ...
    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHSTART);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchStart = &smLaunchStart;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHSTART);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
disman_script_mib_set_smLaunchControl(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, gint32 smLaunchControl)
{
    ...
    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHCONTROL);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchControl = &smLaunchControl;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHCONTROL);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
disman_script_mib_set_smLaunchAdminStatus(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, gint32 smLaunchAdminStatus)
{
    ...
    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHADMINSTATUS);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchAdminStatus = &smLaunchAdminStatus;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHADMINSTATUS);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
disman_script_mib_set_smLaunchStorageType(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, gint32 smLaunchStorageType)
{
    ...
    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHSTORAGETYPE);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchStorageType = &smLaunchStorageType;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHSTORAGETYPE);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
{
    disman_script_mib_smLaunchEntry_t *smLaunchEntry;
    gint32 create = DISMAN_SCRIPT_MIB_SMLAUNCHROWSTATUS_CREATEANDGO;

    smLaunchEntry = disman_script_mib_new_smLaunchEntry();
    memcpy(smLaunchEntry->smLaunchOwner, smLaunchOwner, _smLaunchOwnerLength);
    memcpy(smLaunchEntry->smLaunchName, smLaunchName, _smLaunchNameLength);
    smLaunchEntry->smLaunchRowStatus = &create;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHROWSTATUS);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
{
    disman_script_mib_smLaunchEntry_t *smLaunchEntry;
    gint32 destroy = DISMAN_SCRIPT_MIB_SMLAUNCHROWSTATUS_DESTROY;

    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHROWSTATUS);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchRowStatus = &destroy;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHROWSTATUS);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
disman_script_mib_set_smLaunchRowExpireTime(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, gint32 smLaunchRowExpireTime)
{
    ...
    disman_script_mib_get_smLaunchEntry(s, &smLaunchEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, DISMAN_SCRIPT_MIB_SMLAUNCHROWEXPIRETIME);
    if (s->error_status || !smLaunchEntry) return;
    smLaunchEntry->smLaunchRowExpireTime = &smLaunchRowExpireTime;
    disman_script_mib_set_smLaunchEntry(s, smLaunchEntry, DISMAN_SCRIPT_MIB_SMLAUNCHROWEXPIRETIME);
    disman_script_mib_free_smLaunchEntry(smLaunchEntry);
}
...
disman_script_mib_set_smRunLifeTime(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, gint32 smRunIndex, gint32 smRunLifeTime)
{
    ...
    disman_script_mib_get_smRunEntry(s, &smRunEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, smRunIndex, DISMAN_SCRIPT_MIB_SMRUNLIFETIME);
    if (s->error_status || !smRunEntry) return;
    smRunEntry->smRunLifeTime = &smRunLifeTime;
    disman_script_mib_set_smRunEntry(s, smRunEntry, DISMAN_SCRIPT_MIB_SMRUNLIFETIME);
...
disman_script_mib_set_smRunExpireTime(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, gint32 smRunIndex, gint32 smRunExpireTime)
{
    ...
    disman_script_mib_get_smRunEntry(s, &smRunEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, smRunIndex, DISMAN_SCRIPT_MIB_SMRUNEXPIRETIME);
    if (s->error_status || !smRunEntry) return;
    smRunEntry->smRunExpireTime = &smRunExpireTime;
    disman_script_mib_set_smRunEntry(s, smRunEntry, DISMAN_SCRIPT_MIB_SMRUNEXPIRETIME);
    disman_script_mib_free_smRunEntry(smRunEntry);
}
...
disman_script_mib_set_smRunControl(GSnmpSession *s, guchar *smLaunchOwner, guint16 _smLaunchOwnerLength, guchar *smLaunchName, guint16 _smLaunchNameLength, gint32 smRunIndex, gint32 smRunControl)
{
    ...
    disman_script_mib_get_smRunEntry(s, &smRunEntry, smLaunchOwner, _smLaunchOwnerLength, smLaunchName, _smLaunchNameLength, smRunIndex, DISMAN_SCRIPT_MIB_SMRUNCONTROL);
    if (s->error_status || !smRunEntry) return;
    smRunEntry->smRunControl = &smRunControl;
    disman_script_mib_set_smRunEntry(s, smRunEntry, DISMAN_SCRIPT_MIB_SMRUNCONTROL);
    disman_script_mib_free_smRunEntry(smRunEntry);
}
