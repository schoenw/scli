...
stls_table_t tunnel_mib_enums_tunnelIfEncapsMethod[] = {
    { 1, "other" },
    { 2, "direct" },
    { 3, "gre" },
    { 4, "minimal" },
...
stls_table_t tunnel_mib_enums_tunnelIfSecurity[] = {
    { 1, "none" },
    { 2, "ipsec" },
    { 3, "other" },
    { 0, NULL }
...
stls_table_t tunnel_mib_enums_tunnelConfigEncapsMethod[] = {
    { 1, "other" },
    { 2, "direct" },
    { 3, "gre" },
    { 4, "minimal" },
...
stls_table_t tunnel_mib_enums_tunnelConfigStatus[] = {
    { 1, "active" },
    { 2, "notInService" },
    { 3, "notReady" },
    { 4, "createAndGo" },
