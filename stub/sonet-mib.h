...
extern void
sonet_mib_get_sonetMediumTable(GSnmpSession *s, sonet_mib_sonetMediumEntry_t ***sonetMediumEntry, gint64 mask);
...
extern void
sonet_mib_get_sonetMediumEntry(GSnmpSession *s, sonet_mib_sonetMediumEntry_t **sonetMediumEntry, gint32 ifIndex, gint64 mask);

extern void
sonet_mib_set_sonetMediumEntry(GSnmpSession *s, sonet_mib_sonetMediumEntry_t *sonetMediumEntry, gint64 mask);
...
extern void
sonet_mib_get_sonetSectionCurrentTable(GSnmpSession *s, sonet_mib_sonetSectionCurrentEntry_t ***sonetSectionCurrentEntry, gint64 mask);
...
extern void
sonet_mib_get_sonetSectionCurrentEntry(GSnmpSession *s, sonet_mib_sonetSectionCurrentEntry_t **sonetSectionCurrentEntry, gint32 ifIndex, gint64 mask);
...
extern void
sonet_mib_get_sonetSectionIntervalTable(GSnmpSession *s, sonet_mib_sonetSectionIntervalEntry_t ***sonetSectionIntervalEntry, gint64 mask);
...
extern void
sonet_mib_get_sonetSectionIntervalEntry(GSnmpSession *s, sonet_mib_sonetSectionIntervalEntry_t **sonetSectionIntervalEntry, gint32 ifIndex, gint32 sonetSectionIntervalNumber, gint64 mask);
